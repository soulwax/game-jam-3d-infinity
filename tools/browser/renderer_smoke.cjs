        ...
        ? {
            ...
            solar: result.solarPhase == null
              ...
              : {
                  ...
                  horizonBlend: Number(result.solarHorizonBlend),
  ...
  try {
    ...
    for (const [name, path] of selectedRoutes) {
      ...
      const result = await page.evaluate(() => {
        ...
        fireFlameParticles: canvas.getAttribute('data-renderer-fire-flame-particles'),
        fireWhiteSmokeParticles: canvas.getAttribute('data-renderer-fire-white-smoke-particles'),
        fireBlackSmokeParticles: canvas.getAttribute('data-renderer-fire-black-smoke-particles'),
        ...
        solarHorizonBlend: canvas.getAttribute('data-renderer-solar-horizon-blend'),
        ...
        volumetricMediumScattering: canvas.getAttribute('data-renderer-volumetric-medium-scattering'),
        volumetricDustDensity: canvas.getAttribute('data-renderer-volumetric-dust-density'),
        reflectionIntensity: canvas.getAttribute('data-renderer-reflection-intensity'),
        reflectionConfidence: canvas.getAttribute('data-renderer-reflection-confidence'),
        reflectionMode: canvas.getAttribute('data-renderer-reflection-mode'),
        skyCloudCoverage: canvas.getAttribute('data-renderer-sky-cloud-coverage'),
        skyCloudDensity: canvas.getAttribute('data-renderer-sky-cloud-density'),
        skyCloudSamples: canvas.getAttribute('data-renderer-sky-cloud-samples'),
        skyCloudPhase: canvas.getAttribute('data-renderer-sky-cloud-phase'),
