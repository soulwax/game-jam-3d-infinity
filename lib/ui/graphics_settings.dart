...
class GraphicsSettingsProfile {
  ...
  final bool modelPackageDiagnostics;
  ...
  GraphicsSettingsProfile copyWith({
    ...
    modelPackageDiagnostics:
        modelPackageDiagnostics ?? this.modelPackageDiagnostics,
  );
  ...
  GraphicsSettingsProfile copyWithOption({
    ...
    final updated = copyWith(
      ...
      modelPackageDiagnostics: modelPackageDiagnostics,
    );
    for (final candidate in [
      ...
      if (p.renderScale == updated.renderScale &&
          ...
          p.modelPackageDiagnostics == updated.modelPackageDiagnostics) {
  ...
  factory GraphicsSettingsProfile.fromJson(Object? raw) {
    ...
    final profile = GraphicsSettingsProfile(
      ...
      modelPackageDiagnostics:
          (raw['modelPackageDiagnostics'] ?? raw['fbxDiagnostics']) as bool? ??
          false,
    );
    profile.validate();
    return profile;
