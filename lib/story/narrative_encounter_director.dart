...
class EncounterChoice {
  ...
  EncounterChoice copyWith({String? replyLine}) => EncounterChoice(
    choiceId: choiceId,
    label: label,
    effects: effects,
    replyLine: replyLine ?? this.replyLine,
  );
...
class ActiveEncounter {
  ...
  /// The earlier human fact which made this visit speak differently.
  /// Null means the canonical line is being used.
  ...
  ActiveEncounter copyWith({
    ...
    visitor: visitor,
    day: day,
    promptLine: promptLine ?? this.promptLine,
    choices: choices ?? this.choices,
    callbackSource: callbackSource ?? this.callbackSource,
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (callbackSource != null) 'callbackSource': callbackSource,
...
class NarrativeEncounterDirector {
  ...
  ActiveEncounter? resolveEncounter(int day) {
    final encounter = _resolveCanonicalEncounter(day);
    return encounter == null ? null : _applyHumanCallbacks(encounter);
  }

  /// The unmodified day matrix. Keeping this private makes it impossible for
  /// a callback to accidentally rewrite the authored schedule itself.
  ActiveEncounter? _resolveCanonicalEncounter(int day) {
    switch (day) {
      case 1:
        return const ActiveEncounter(
          ...
          day: 1,
          promptLine:
              'Ayling? It is Mrs Ashworth. I left a jug of mutton broth by the boot-scraper. The order says we tap three times if the stove smokes.',
          choices: [
            EncounterChoice(
              choiceId: 'accept',
              ...
              effects: {
                ...
                'residue.broth': 'threshold',
              },
              replyLine:
                  'Good boy. Keep the draught-excluder tight against the front hall.',
            ),
            EncounterChoice(
              choiceId: 'decline',
      ...
      case 2:
        return const ActiveEncounter(
          ...
          day: 2,
          promptLine:
              'I brought the ration parcel and four pears from the back garden.',
          choices: [
            EncounterChoice(
              choiceId: 'take',
      ...
      case 3:
        return const ActiveEncounter(
          ...
          day: 3,
          promptLine:
              'Ayling, sign the exemption slip. The mill-house cannot idle.',
          choices: [
            EncounterChoice(
              choiceId: 'grant',
      ...
      case 4:
        return const ActiveEncounter(
          ...
          day: 4,
          promptLine:
              'Post Office Lines. Need to verify the copper drop-wire on your chimney breast.',
          choices: [
            EncounterChoice(
              choiceId: 'allow',
              ...
              replyLine:
                  'Signal is humming clear enough. Keep away from the lead flashing.',
            ),
            EncounterChoice(
              choiceId: 'dismiss',
      ...
      case 5:
        return const ActiveEncounter(
          ...
          day: 5,
          promptLine:
              'Delivered two sacks of anthracite. Latches on the cellar shutter are loose.',
          choices: [
            EncounterChoice(
              choiceId: 'tip',
      ...
      case 6:
        return const ActiveEncounter(
          ...
          day: 6,
          promptLine:
              'Dr Hallow. Hold your hand against the glass pane so I may see the tremor.',
          choices: [
            EncounterChoice(
              choiceId: 'comply',
              ...
              replyLine:
                  'Nails are clear. Do not let the coal gas pool near your bed.',
            ),
            EncounterChoice(
              choiceId: 'refuse',
              label: 'Step back into the shadow of the hall',
              effects: {
                'hallow.tremor': 'concealed',
                'truth.vitality': 'suspect',
              },
      ...
      case 7:
        return const ActiveEncounter(
          ...
          day: 7,
          promptLine:
              'First week done, Ayling. Did you hear the tapping at dawn through the chimney flue?',
          choices: [
            EncounterChoice(
              choiceId: 'heard',
              ...
              replyLine:
                  'It was three beats, then two. As long as you answer, I know you are above ground.',
            ),
            EncounterChoice(
              choiceId: 'silence',
              ...
              replyLine:
                  'Then there is someone else walking in the terrace crawlway.',
            ),
          ],
        );
      case 8:
        return const ActiveEncounter(
          ...
          day: 8,
          promptLine:
              'Telegram from the Ministry District Bureau. Slipped under the draught runner.',
          choices: [
            EncounterChoice(
              choiceId: 'open',
              ...
              effects: {
                'telegram.08': 'read',
                'residue.telegram': 'hall_floor',
              },
              replyLine:
                  'No signature needed. All rations reduced by one dram starting Tuesday.',
            ),
            EncounterChoice(
              choiceId: 'burn',
              ...
              replyLine:
                  'Makes no difference to the depot. What is ordered is ordered.',
            ),
          ],
        );
      case 9:
        return const ActiveEncounter(
          ...
          day: 9,
          promptLine:
              'I found mother’s tartan shawl in the chest. You always said she left it in Leeds.',
          choices: [
            EncounterChoice(
              choiceId: 'concede',
            ...
            EncounterChoice(
              ...
              replyLine:
                  'Look at the label stitching then. Look at it tonight.',
            ),
          ],
        );
      case 10:
        return const ActiveEncounter(
          ...
          day: 10,
          promptLine:
              'The district council needs the spare room for billeting logistics. I hold the town key.',
          choices: [
            EncounterChoice(
              ...
              replyLine:
                  'Order is maintained when each man remembers his place.',
            ),
            EncounterChoice(
              choiceId: 'withhold',
              ...
              replyLine:
                  'When the quarantine lifts, you will answer for every locked latch.',
            ),
          ],
        );
      case 11:
        return const ActiveEncounter(
          ...
          day: 11,
          promptLine:
              'Reverend Colclough. We are reciting the Names of the Fallen across the hedge. Shall I include Leonard?',
          choices: [
            EncounterChoice(
              choiceId: 'include',
              label: 'Give Leonard’s battalion and rank',
              effects: {
                'colclough.leonard': 'read',
                'truth.leonard': 'remembered',
              },
              replyLine:
                  'He is entered on the vellum roll. God preserve what remains.',
            ),
            EncounterChoice(
              choiceId: 'omit',
              label: 'Ask for no names to be spoken at your door',
              effects: {
                'colclough.leonard': 'omitted',
                'truth.leonard': 'unspoken',
              },
              replyLine:
                  'Silence does not make the dead less departed, Ayling.',
            ),
          ],
        );
      case 12:
        return const ActiveEncounter(
          ...
          day: 12,
          promptLine:
              'Ministry Sanitary Guard. Inspection of outer wax seals and window restrictors.',
          choices: [
            EncounterChoice(
              choiceId: 'affirm',
              ...
              replyLine:
                  'Seals verified intact. Red band remains on your doorpost.',
            ),
            EncounterChoice(
              choiceId: 'report_breach',
              label: 'Report a cracked seal on the kitchen window',
              effects: {
                'inspector.seals': 'breached',
                'truth.seals': 'compromised',
              },
              replyLine:
                  'Noted in the red book. Your isolation clock resets four days.',
            ),
          ],
        );
      case 13:
        return const ActiveEncounter(
          ...
          day: 13,
          promptLine:
              'Got one gallon of paraffin. Town supply is rationed tight since the fire at the wharf.',
          choices: [
            EncounterChoice(
              choiceId: 'take_fuel',
              label: 'Accept the paraffin tin',
              effects: {
                'sowerby.paraffin': 'received',
                'residue.paraffin': 'scullery',
              },
              replyLine:
                  'Do not spill a drop on the floorboards; it eats the bitumen.',
            ),
            EncounterChoice(
      ...
      case 14:
        return const ActiveEncounter(
          ...
          day: 14,
          promptLine:
              'You tapped four times last night, Ayling. The code was only ever three.',
          choices: [
            EncounterChoice(
              choiceId: 'explain',
              ...
              replyLine:
                  'Wind does not tap in triplets with a pause for breath.',
            ),
            EncounterChoice(
              choiceId: 'admit',
      ...
      case 15:
        return const ActiveEncounter(
          ...
          day: 15,
          promptLine:
              'Is this the house of Thomas Ayling? Open the glass. I have the papers from the canal basin.',
          choices: [
            EncounterChoice(
              choiceId: 'speak',
              label: 'Demand identification through the letterbox',
              effects: {
                'stranger.15': 'interrogated',
                'truth.canal': 'discovered',
              },
      ...
      case 16:
        return const ActiveEncounter(
          ...
          day: 16,
          promptLine:
              'Ayling, someone took the canal docket from the bureau drawer. Did you give Sylvia the key?',
          choices: [
            EncounterChoice(
              choiceId: 'confess',
              ...
              effects: {
                ...
                'truth.bureau': 'searched',
              },
              replyLine:
                  'You let her inside our father’s ledger room. How could you?',
            ),
            EncounterChoice(
              choiceId: 'deny',
              ...
              replyLine:
                  'Then she had a duplicate made before you were shut in.',
            ),
          ],
        );
      case 17:
        return const ActiveEncounter(
          ...
          day: 17,
          promptLine:
              'The quarantine ends in four days. The parish committee will review the mill ledgers.',
          choices: [
            EncounterChoice(
              choiceId: 'stand_firm',
              label: 'State the truth of the accounts will be presented',
              effects: {
                'sylvia.ultimatum': 'defied',
                'truth.accounts': 'honest',
              },
              replyLine:
                  'You will find truth is an expensive luxury when the war bill arrives.',
            ),
            EncounterChoice(
              choiceId: 'settle',
              label: 'Offer to sign a joint reconciliation statement',
              effects: {
                'sylvia.ultimatum': 'appeased',
                'truth.accounts': 'reconciled',
              },
      ...
      case 18:
        return const ActiveEncounter(
          ...
          day: 18,
          promptLine:
              'Medical discharge evaluation. State your pulse and whether the wall-sounds have ceased.',
          choices: [
            EncounterChoice(
              choiceId: 'sound',
              label: 'Report normal health and clear mind',
              effects: {
                'hallow.discharge': 'cleared',
                'truth.sanity': 'certified',
              },
            ...
            EncounterChoice(
              ...
              effects: {
                'hallow.discharge': 'conditional',
                'truth.sanity': 'questioned',
              },
              replyLine:
                  'Prolonged isolation leaves an echo in the ears. It passes.',
            ),
          ],
        );
      case 19:
        return const ActiveEncounter(
          ...
          day: 19,
          promptLine:
              'Posting the final unsealing proclamation on your lintel.',
          choices: [
            EncounterChoice(
              ...
              replyLine:
                  'Forty-eight hours remaining. Prepare your household articles for fumigation.',
            ),
            EncounterChoice(
              choiceId: 'wait',
      ...
      case 20:
        return const ActiveEncounter(
          ...
          day: 20,
          promptLine:
              'Tomorrow the street opens, Ayling. Will you walk out to the churchyard or stay inside?',
          choices: [
            EncounterChoice(
              choiceId: 'walk_out',
              label: 'Promise to walk out to the morning service',
              effects: {
                'ashworth.farewell': 'rejoined',
                'truth.future': 'public',
              },
            ...
            EncounterChoice(
              ...
              effects: {
                'ashworth.farewell': 'reclusive',
                'truth.future': 'isolated',
              },
              replyLine:
                  'The quarantine ends on paper, Ayling. Not always in the bones.',
            ),
          ],
        );
      case 21:
        return const ActiveEncounter(
          ...
          day: 21,
          promptLine:
              'The bolt is drawn from the outside, Ayling. You can turn the brass latch now.',
          choices: [
            EncounterChoice(
              choiceId: 'open_door',
              ...
              replyLine:
                  'Welcome back to the world. It changed while you were asleep.',
            ),
            EncounterChoice(
              choiceId: 'remain_threshold',
              label: 'Stand at the open threshold without crossing',
              effects: {
                'ending.choice': 'threshold',
                'truth.finale': 'suspended',
              },
  ...
  /// Revoices only the later visit that actually remembers an earlier act.
  ///
  /// These are deliberately domestic callbacks: a jug is absent, a rhythm is
  /// answered, a form is carried forward. They never explain the boundary or
  /// promote a character's memory into objective truth.
  ActiveEncounter _applyHumanCallbacks(ActiveEncounter encounter) {
    ActiveEncounter result = encounter;

    if (encounter.day == 7) {
      if (state.hasFlag('ashworth.compact', 'accepted')) {
        result = encounter.copyWith(
          promptLine:
              'First week done. The jug came back empty. Did you hear the tapping at dawn through the chimney flue?',
          callbackSource: 'ashworth.compact=accepted',
        );
      } else if (state.hasFlag('ashworth.compact', 'declined')) {
        result = encounter.copyWith(
          promptLine:
              'First week done. I did not leave anything this time. Did you hear the tapping at dawn through the chimney flue?',
          callbackSource: 'ashworth.compact=declined',
        );
      }
    } else if (encounter.day == 9) {
      if (state.hasFlag('denise.pears', 'taken')) {
        result = encounter.copyWith(
          promptLine:
              'I found mother’s tartan shawl in the chest. The pears were good, weren’t they? You always said she left it in Leeds.',
          callbackSource: 'denise.pears=taken',
        );
      } else if (state.hasFlag('denise.pears', 'left')) {
        result = encounter.copyWith(
          promptLine:
              'I found mother’s tartan shawl in the chest. I hope the pears did not freeze. You always said she left it in Leeds.',
          callbackSource: 'denise.pears=left',
        );
      }
    } else if (encounter.day == 14) {
      if (state.hasFlag('ashworth.taps', 'confirmed')) {
        result = encounter.copyWith(
          promptLine:
              'You tapped four times last night, Ayling. I answered with three, as agreed. The code was only ever three.',
          callbackSource: 'ashworth.taps=confirmed',
        );
      }
    } else if (encounter.day == 17) {
      if (state.hasFlag('sylvia.spare_room', 'accessible')) {
        result = encounter.copyWith(
          promptLine:
              'The quarantine ends in four days. The committee will review the mill ledgers. I found the spare room exactly as you left it.',
          callbackSource: 'sylvia.spare_room=accessible',
        );
      }
    } else if (encounter.day == 18) {
      if (state.hasFlag('hallow.tremor', 'normal')) {
        result = encounter.copyWith(
          promptLine:
              'Medical discharge evaluation. Your hand was steady last time. State your pulse and whether the wall-sounds have ceased.',
          callbackSource: 'hallow.tremor=normal',
        );
      }
    } else if (encounter.day == 20) {
      if (state.hasFlag('ashworth.rhythm', 'checked_comfort')) {
        result = encounter.copyWith(
          promptLine:
              'Tomorrow the street opens, Ayling. You checked whether I still answered. Will you walk out to the churchyard or stay inside?',
          callbackSource: 'ashworth.rhythm=checked_comfort',
        );
      }
    } else if (encounter.day == 21) {
      if (state.hasFlag('denise.docket', 'betrayed')) {
        result = encounter.copyWith(
          promptLine:
              'The bolt is drawn from the outside, Ayling. The ledger room is still open behind you. You can turn the brass latch now.',
          callbackSource: 'denise.docket=betrayed',
        );
      } else if (state.hasFlag('denise.memory', 'conceded')) {
        result = encounter.copyWith(
          promptLine:
              'The bolt is drawn from the outside, Ayling. You were right about one thing, and wrong about another. Turn the brass latch when you are ready.',
          callbackSource: 'denise.memory=conceded',
        );
      }
    }
