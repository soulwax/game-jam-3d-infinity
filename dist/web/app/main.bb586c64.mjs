...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _276: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._276(f,arguments.length,x0) }),
      _277: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _278: x0 => x0.getSupportedExtensions(),
      _279: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _280: (x0,x1) => x0.getParameter(x1),
      _281: x0 => x0.createQuery(),
      _282: (x0,x1,x2) => x0.beginQuery(x1,x2),
      _283: (x0,x1) => x0.endQuery(x1),
      _285: (x0,x1) => x0.deleteQuery(x1),
      _286: (x0,x1,x2) => x0.bindFramebuffer(x1,x2),
      _287: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      _288: (x0,x1) => x0.drawBuffers(x1),
      _289: (x0,x1) => x0.readBuffer(x1),
      _290: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => x0.blitFramebuffer(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10),
      _291: (x0,x1) => x0.activeTexture(x1),
      _292: (x0,x1,x2) => x0.bindTexture(x1,x2),
      _293: (x0,x1) => x0.enable(x1),
      _294: (x0,x1) => x0.disable(x1),
      _295: (x0,x1) => x0.depthFunc(x1),
      _296: (x0,x1) => x0.depthMask(x1),
      _297: (x0,x1) => x0.cullFace(x1),
      _298: (x0,x1) => x0.frontFace(x1),
      _299: (x0,x1,x2) => x0.blendFunc(x1,x2),
      _300: (x0,x1) => x0.blendEquation(x1),
      _301: (x0,x1,x2,x3,x4) => x0.colorMask(x1,x2,x3,x4),
      _302: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      _303: (x0,x1) => x0.clear(x1),
      _304: (x0,x1) => x0.useProgram(x1),
      _305: (x0,x1,x2) => x0.getUniformLocation(x1,x2),
      _306: (x0,x1,x2) => x0.uniform1f(x1,x2),
      _307: (x0,x1,x2,x3) => x0.uniform2f(x1,x2,x3),
      _308: (x0,x1,x2,x3,x4) => x0.uniform3f(x1,x2,x3,x4),
      _309: (x0,x1,x2,x3,x4,x5) => x0.uniform4f(x1,x2,x3,x4,x5),
      _310: (x0,x1,x2,x3) => x0.uniformMatrix4fv(x1,x2,x3),
      _311: (x0,x1,x2) => x0.uniform1i(x1,x2),
      _312: (x0,x1) => x0.bindVertexArray(x1),
      _313: (x0,x1,x2) => x0.bindBuffer(x1,x2),
      _314: (x0,x1,x2,x3,x4,x5,x6) => x0.vertexAttribPointer(x1,x2,x3,x4,x5,x6),
      _315: (x0,x1) => x0.enableVertexAttribArray(x1),
      _316: (x0,x1,x2,x3) => x0.bufferData(x1,x2,x3),
      _317: (x0,x1,x2,x3) => x0.drawArrays(x1,x2,x3),
      _318: (x0,x1,x2,x3,x4) => x0.drawArraysInstanced(x1,x2,x3,x4),
      _319: (x0,x1,x2,x3,x4) => x0.drawElements(x1,x2,x3,x4),
      _320: (x0,x1,x2,x3,x4,x5) => x0.drawElementsInstanced(x1,x2,x3,x4,x5),
      _321: x0 => x0.createBuffer(),
      _322: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      _323: (x0,x1) => x0.deleteBuffer(x1),
      _324: x0 => x0.createTexture(),
      _325: (x0,x1,x2,x3,x4,x5,x6) => x0.texStorage3D(x1,x2,x3,x4,x5,x6),
      _326: (x0,x1,x2,x3,x4,x5) => x0.texStorage2D(x1,x2,x3,x4,x5),
      _327: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      _328: (x0,x1,x2,x3) => x0.texParameterf(x1,x2,x3),
      _329: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11) => x0.texSubImage3D(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11),
      _330: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texSubImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _331: (x0,x1) => x0.generateMipmap(x1),
      _332: (x0,x1) => x0.deleteTexture(x1),
      _333: x0 => x0.createFramebuffer(),
      _334: x0 => x0.createRenderbuffer(),
      _335: (x0,x1,x2) => x0.bindRenderbuffer(x1,x2),
      _336: (x0,x1,x2,x3,x4,x5) => x0.renderbufferStorageMultisample(x1,x2,x3,x4,x5),
      _337: (x0,x1,x2,x3,x4) => x0.framebufferRenderbuffer(x1,x2,x3,x4),
      _338: (x0,x1,x2,x3,x4,x5) => x0.framebufferTexture2D(x1,x2,x3,x4,x5),
      _339: (x0,x1) => x0.checkFramebufferStatus(x1),
      _340: (x0,x1) => x0.deleteFramebuffer(x1),
      _341: (x0,x1) => x0.deleteRenderbuffer(x1),
      _342: x0 => x0.createVertexArray(),
      _343: (x0,x1) => x0.deleteVertexArray(x1),
      ...
      _349: (x0,x1) => x0.deleteShader(x1),
      _350: x0 => x0.createProgram(),
      _351: (x0,x1,x2) => x0.attachShader(x1,x2),
      _352: (x0,x1) => x0.linkProgram(x1),
      _353: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      _354: (x0,x1) => x0.getProgramInfoLog(x1),
      _355: (x0,x1) => x0.deleteProgram(x1),
      _356: (x0,x1,x2) => x0.getAttribLocation(x1,x2),
      _357: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _358: x0 => x0.decode(),
      _359: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _360: (x0,x1,x2,x3,x4) => x0.getImageData(x1,x2,x3,x4),
      _361: (x0,x1) => x0.warn(x1),
      _362: (x0,x1) => x0.hasAttribute(x1),
      _363: x0 => globalThis.Object.keys(x0),
      _364: (x0,x1) => x0.getElementById(x1),
      _365: x0 => x0.focus(),
      _366: (x0,x1) => x0.contains(x1),
      _367: (x0,x1,x2) => x0.toggle(x1,x2),
      _368: (x0,x1,x2) => x0.setProperty(x1,x2),
      _369: (x0,x1) => x0.matchMedia(x1),
      ...
      _382: (x0,x1) => x0.requestAnimationFrame(x1),
      _383: x0 => x0.getBoundingClientRect(),
      ...
      _386: (x0,x1) => x0.getAttribute(x1),
      _387: (x0,x1) => x0.error(x1),
      _388: (x0,x1) => x0.fetch(x1),
      _389: x0 => x0.json(),
      _390: x0 => x0.text(),
      _391: (x0,x1) => x0.contains(x1),
      _392: (x0,x1) => x0.querySelectorAll(x1),
      _393: (x0,x1) => x0.item(x1),
      _394: (x0,x1) => x0.removeAttribute(x1),
      ...
      _410: (x0,x1) => x0.removeChild(x1),
      _411: x0 => x0.save(),
      _412: (x0,x1,x2) => x0.scale(x1,x2),
      _413: (x0,x1,x2,x3,x4) => x0.clearRect(x1,x2,x3,x4),
      _414: x0 => x0.restore(),
      _415: (x0,x1,x2) => x0.translate(x1,x2),
      _416: x0 => x0.fill(),
      _417: x0 => x0.stroke(),
      _418: (x0,x1) => x0.rotate(x1),
      _419: x0 => x0.beginPath(),
      _420: (x0,x1,x2) => x0.moveTo(x1,x2),
      _421: (x0,x1,x2) => x0.lineTo(x1,x2),
      _422: (x0,x1,x2,x3,x4,x5) => x0.arc(x1,x2,x3,x4,x5),
      _423: (x0,x1,x2,x3) => x0.fillText(x1,x2,x3),
      _424: (x0,x1,x2,x3,x4) => x0.strokeRect(x1,x2,x3,x4),
      _425: (x0,x1) => x0.measureText(x1),
      _426: (x0,x1,x2,x3,x4) => x0.fillRect(x1,x2,x3,x4),
      _427: (x0,x1,x2,x3,x4) => x0.rect(x1,x2,x3,x4),
      _428: x0 => x0.clip(),
