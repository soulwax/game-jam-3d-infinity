...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _415: x0 => x0.start(),
      _416: x0 => x0.createPanner(),
      _417: (x0,x1,x2,x3) => x0.setPosition(x1,x2,x3),
      _418: (x0,x1,x2,x3,x4,x5,x6) => x0.setOrientation(x1,x2,x3,x4,x5,x6),
      _423: o => o instanceof Array,
      _432: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _433: a => a.length,
      _435: (a, i) => a[i],
      _436: (a, i, v) => a[i] = v,
      _441: o => {
      ...
      _442: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _443: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _444: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _445: o => o instanceof Uint8ClampedArray,
      _446: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _447: o => o instanceof Uint16Array,
      _448: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _449: o => o instanceof Int16Array,
      _450: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _451: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _452: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _453: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _454: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _457: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _458: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _459: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _460: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _462: (t, s) => t.set(s),
      _464: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _466: o => o.buffer,
      _467: o => o.byteOffset,
      _468: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _469: (b, o) => new DataView(b, o),
      _470: (b, o, l) => new DataView(b, o, l),
      _471: Function.prototype.call.bind(DataView.prototype.getUint8),
      _472: Function.prototype.call.bind(DataView.prototype.setUint8),
      _473: Function.prototype.call.bind(DataView.prototype.getInt8),
      _474: Function.prototype.call.bind(DataView.prototype.setInt8),
      _475: Function.prototype.call.bind(DataView.prototype.getUint16),
      _476: Function.prototype.call.bind(DataView.prototype.setUint16),
      _477: Function.prototype.call.bind(DataView.prototype.getInt16),
      _478: Function.prototype.call.bind(DataView.prototype.setInt16),
      _479: Function.prototype.call.bind(DataView.prototype.getUint32),
      _480: Function.prototype.call.bind(DataView.prototype.setUint32),
      _481: Function.prototype.call.bind(DataView.prototype.getInt32),
      _482: Function.prototype.call.bind(DataView.prototype.setInt32),
      _487: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _488: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _489: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _490: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _491: Function.prototype.call.bind(Number.prototype.toString),
      _492: Function.prototype.call.bind(BigInt.prototype.toString),
      _493: Function.prototype.call.bind(Number.prototype.toString),
      _494: (d, digits) => d.toFixed(digits),
      _610: x0 => x0.style,
      _1053: (x0,x1) => { x0.src = x1 },
      _1066: x0 => x0.width,
      _1068: x0 => x0.height,
      _1069: x0 => x0.naturalWidth,
      _1070: x0 => x0.naturalHeight,
      _1892: (x0,x1) => { x0.width = x1 },
      _1893: x0 => x0.width,
      _1894: (x0,x1) => { x0.height = x1 },
      _1895: x0 => x0.height,
      _2024: x0 => x0.data,
      _2253: () => globalThis.window,
      _2289: x0 => x0.innerWidth,
      _2290: x0 => x0.innerHeight,
      _2305: x0 => x0.document,
      _2308: x0 => x0.location,
      _2586: x0 => x0.localStorage,
      _2608: x0 => x0.search,
      _2758: x0 => x0.message,
      _2776: x0 => x0.reason,
      _4084: () => globalThis.WebGL2RenderingContext.DEPTH_BUFFER_BIT,
      _4086: () => globalThis.WebGL2RenderingContext.COLOR_BUFFER_BIT,
      _4091: () => globalThis.WebGL2RenderingContext.TRIANGLES,
      _4094: () => globalThis.WebGL2RenderingContext.ZERO,
      _4095: () => globalThis.WebGL2RenderingContext.ONE,
      _4098: () => globalThis.WebGL2RenderingContext.SRC_ALPHA,
      _4099: () => globalThis.WebGL2RenderingContext.ONE_MINUS_SRC_ALPHA,
      _4100: () => globalThis.WebGL2RenderingContext.DST_ALPHA,
      _4101: () => globalThis.WebGL2RenderingContext.ONE_MINUS_DST_ALPHA,
      _4105: () => globalThis.WebGL2RenderingContext.FUNC_ADD,
      _4109: () => globalThis.WebGL2RenderingContext.FUNC_SUBTRACT,
      _4110: () => globalThis.WebGL2RenderingContext.FUNC_REVERSE_SUBTRACT,
      _4120: () => globalThis.WebGL2RenderingContext.ARRAY_BUFFER,
      _4121: () => globalThis.WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER,
      _4124: () => globalThis.WebGL2RenderingContext.STREAM_DRAW,
      _4125: () => globalThis.WebGL2RenderingContext.STATIC_DRAW,
      _4126: () => globalThis.WebGL2RenderingContext.DYNAMIC_DRAW,
      _4130: () => globalThis.WebGL2RenderingContext.FRONT,
      _4131: () => globalThis.WebGL2RenderingContext.BACK,
      _4133: () => globalThis.WebGL2RenderingContext.CULL_FACE,
      _4134: () => globalThis.WebGL2RenderingContext.BLEND,
      _4137: () => globalThis.WebGL2RenderingContext.DEPTH_TEST,
      _4138: () => globalThis.WebGL2RenderingContext.SCISSOR_TEST,
      _4142: () => globalThis.WebGL2RenderingContext.NO_ERROR,
      _4148: () => globalThis.WebGL2RenderingContext.CCW,
      _4179: () => globalThis.WebGL2RenderingContext.MAX_TEXTURE_SIZE,
      _4201: () => globalThis.WebGL2RenderingContext.UNSIGNED_BYTE,
      _4203: () => globalThis.WebGL2RenderingContext.UNSIGNED_SHORT,
      _4206: () => globalThis.WebGL2RenderingContext.FLOAT,
      _4210: () => globalThis.WebGL2RenderingContext.RGBA,
      _4216: () => globalThis.WebGL2RenderingContext.FRAGMENT_SHADER,
      _4217: () => globalThis.WebGL2RenderingContext.VERTEX_SHADER,
      _4218: () => globalThis.WebGL2RenderingContext.MAX_VERTEX_ATTRIBS,
      _4227: () => globalThis.WebGL2RenderingContext.LINK_STATUS,
      _4234: () => globalThis.WebGL2RenderingContext.NEVER,
      _4235: () => globalThis.WebGL2RenderingContext.LESS,
      _4237: () => globalThis.WebGL2RenderingContext.LEQUAL,
      _4241: () => globalThis.WebGL2RenderingContext.ALWAYS,
      _4249: () => globalThis.WebGL2RenderingContext.VENDOR,
      _4250: () => globalThis.WebGL2RenderingContext.RENDERER,
      _4252: () => globalThis.WebGL2RenderingContext.NEAREST,
      _4253: () => globalThis.WebGL2RenderingContext.LINEAR,
      _4257: () => globalThis.WebGL2RenderingContext.LINEAR_MIPMAP_LINEAR,
      _4258: () => globalThis.WebGL2RenderingContext.TEXTURE_MAG_FILTER,
      _4259: () => globalThis.WebGL2RenderingContext.TEXTURE_MIN_FILTER,
      _4260: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_S,
      _4261: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_T,
      _4262: () => globalThis.WebGL2RenderingContext.TEXTURE_2D,
      _4273: () => globalThis.WebGL2RenderingContext.TEXTURE0,
      _4274: () => globalThis.WebGL2RenderingContext.TEXTURE1,
      _4280: () => globalThis.WebGL2RenderingContext.TEXTURE7,
      _4281: () => globalThis.WebGL2RenderingContext.TEXTURE8,
      _4282: () => globalThis.WebGL2RenderingContext.TEXTURE9,
      _4283: () => globalThis.WebGL2RenderingContext.TEXTURE10,
      _4284: () => globalThis.WebGL2RenderingContext.TEXTURE11,
      _4306: () => globalThis.WebGL2RenderingContext.REPEAT,
      _4307: () => globalThis.WebGL2RenderingContext.CLAMP_TO_EDGE,
      _4333: () => globalThis.WebGL2RenderingContext.COMPILE_STATUS,
      _4340: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER,
      _4341: () => globalThis.WebGL2RenderingContext.RENDERBUFFER,
      _4344: () => globalThis.WebGL2RenderingContext.RGBA8,
      _4362: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT0,
      _4363: () => globalThis.WebGL2RenderingContext.DEPTH_ATTACHMENT,
      _4366: () => globalThis.WebGL2RenderingContext.NONE,
      _4367: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER_COMPLETE,
      _4376: () => globalThis.WebGL2RenderingContext.UNPACK_FLIP_Y_WEBGL,
      _4409: () => globalThis.WebGL2RenderingContext.DEPTH_COMPONENT24,
      _4463: () => globalThis.WebGL2RenderingContext.MAX_ARRAY_TEXTURE_LAYERS,
      _4467: () => globalThis.WebGL2RenderingContext.TEXTURE_2D_ARRAY,
      _4531: () => globalThis.WebGL2RenderingContext.READ_FRAMEBUFFER,
      _4532: () => globalThis.WebGL2RenderingContext.DRAW_FRAMEBUFFER,
      _4536: () => globalThis.WebGL2RenderingContext.MAX_COLOR_ATTACHMENTS,
      _4537: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT1,
      _4553: () => globalThis.WebGL2RenderingContext.MAX_SAMPLES,
      _4797: x0 => x0.canvas,
      _4798: x0 => x0.drawingBufferWidth,
      _4799: x0 => x0.drawingBufferHeight,
      _5407: x0 => x0.destination,
      _5408: x0 => x0.sampleRate,
      _5410: x0 => x0.listener,
      _5411: x0 => x0.state,
      _5528: (x0,x1) => { x0.value = x1 },
      _5564: (x0,x1) => { x0.buffer = x1 },
      _5566: x0 => x0.playbackRate,
      _5610: (x0,x1) => { x0.type = x1 },
      _5612: x0 => x0.frequency,
      _5641: (x0,x1) => { x0.buffer = x1 },
      _5676: x0 => x0.gain,
      _5721: (x0,x1) => { x0.panningModel = x1 },
      _5723: x0 => x0.positionX,
      _5724: x0 => x0.positionY,
      _5725: x0 => x0.positionZ,
      _5729: (x0,x1) => { x0.distanceModel = x1 },
      _5731: (x0,x1) => { x0.refDistance = x1 },
      _5733: (x0,x1) => { x0.maxDistance = x1 },
      _5735: (x0,x1) => { x0.rolloffFactor = x1 },
      _5737: (x0,x1) => { x0.coneInnerAngle = x1 },
      _6905: x0 => x0.type,
      _6916: x0 => x0.defaultPrevented,
      _6956: x0 => x0.length,
      _7033: (x0,x1) => { x0.textContent = x1 },
      _7038: () => globalThis.document,
      _7101: x0 => x0.documentElement,
      _7115: x0 => x0.body,
      _7151: x0 => x0.activeElement,
