...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _384: x0 => x0.focus(),
      _385: (x0,x1) => x0.querySelectorAll(x1),
      _386: (x0,x1) => x0.item(x1),
      ...
      _396: (x0,x1,x2) => x0.setTimeout(x1,x2),
      _397: (x0,x1) => x0.removeItem(x1),
      ...
      _402: x0 => x0.createGain(),
      _403: x0 => x0.createConvolver(),
      _404: (x0,x1) => x0.connect(x1),
      _405: x0 => x0.createBiquadFilter(),
      _406: (x0,x1) => x0.disconnect(x1),
      _407: x0 => x0.resume(),
      _408: () => new AudioContext(),
      _409: x0 => x0.arrayBuffer(),
      _410: (x0,x1) => x0.decodeAudioData(x1),
      _411: (x0,x1,x2,x3) => x0.createBuffer(x1,x2,x3),
      _412: (x0,x1,x2) => x0.copyToChannel(x1,x2),
      _413: x0 => x0.createBufferSource(),
      _414: x0 => x0.start(),
      _415: x0 => x0.createPanner(),
      _416: (x0,x1,x2,x3) => x0.setPosition(x1,x2,x3),
      _417: (x0,x1,x2,x3,x4,x5,x6) => x0.setOrientation(x1,x2,x3,x4,x5,x6),
      _422: o => o instanceof Array,
      _431: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _432: a => a.length,
      _434: (a, i) => a[i],
      _435: (a, i, v) => a[i] = v,
      _440: o => {
      ...
      _441: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _442: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _443: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _444: o => o instanceof Uint8ClampedArray,
      _445: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _446: o => o instanceof Uint16Array,
      _447: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _448: o => o instanceof Int16Array,
      _449: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _450: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _451: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _452: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _453: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _456: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _457: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _458: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _459: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _461: (t, s) => t.set(s),
      _463: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _465: o => o.buffer,
      _466: o => o.byteOffset,
      _467: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _468: (b, o) => new DataView(b, o),
      _469: (b, o, l) => new DataView(b, o, l),
      _470: Function.prototype.call.bind(DataView.prototype.getUint8),
      _471: Function.prototype.call.bind(DataView.prototype.setUint8),
      _472: Function.prototype.call.bind(DataView.prototype.getInt8),
      _473: Function.prototype.call.bind(DataView.prototype.setInt8),
      _474: Function.prototype.call.bind(DataView.prototype.getUint16),
      _475: Function.prototype.call.bind(DataView.prototype.setUint16),
      _476: Function.prototype.call.bind(DataView.prototype.getInt16),
      _477: Function.prototype.call.bind(DataView.prototype.setInt16),
      _478: Function.prototype.call.bind(DataView.prototype.getUint32),
      _479: Function.prototype.call.bind(DataView.prototype.setUint32),
      _480: Function.prototype.call.bind(DataView.prototype.getInt32),
      _481: Function.prototype.call.bind(DataView.prototype.setInt32),
      _486: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _487: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _488: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _489: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _490: Function.prototype.call.bind(Number.prototype.toString),
      _491: Function.prototype.call.bind(BigInt.prototype.toString),
      _492: Function.prototype.call.bind(Number.prototype.toString),
      _493: (d, digits) => d.toFixed(digits),
      _609: x0 => x0.style,
      _1052: (x0,x1) => { x0.src = x1 },
      _1065: x0 => x0.width,
      _1067: x0 => x0.height,
      _1068: x0 => x0.naturalWidth,
      _1069: x0 => x0.naturalHeight,
      _1891: (x0,x1) => { x0.width = x1 },
      _1892: x0 => x0.width,
      _1893: (x0,x1) => { x0.height = x1 },
      _1894: x0 => x0.height,
      _2023: x0 => x0.data,
      _2252: () => globalThis.window,
      _2288: x0 => x0.innerWidth,
      _2289: x0 => x0.innerHeight,
      _2304: x0 => x0.document,
      _2307: x0 => x0.location,
      _2585: x0 => x0.localStorage,
      _2607: x0 => x0.search,
      _2757: x0 => x0.message,
      _2775: x0 => x0.reason,
      _4083: () => globalThis.WebGL2RenderingContext.DEPTH_BUFFER_BIT,
      _4085: () => globalThis.WebGL2RenderingContext.COLOR_BUFFER_BIT,
      _4090: () => globalThis.WebGL2RenderingContext.TRIANGLES,
      _4093: () => globalThis.WebGL2RenderingContext.ZERO,
      _4094: () => globalThis.WebGL2RenderingContext.ONE,
      _4097: () => globalThis.WebGL2RenderingContext.SRC_ALPHA,
      _4098: () => globalThis.WebGL2RenderingContext.ONE_MINUS_SRC_ALPHA,
      _4099: () => globalThis.WebGL2RenderingContext.DST_ALPHA,
      _4100: () => globalThis.WebGL2RenderingContext.ONE_MINUS_DST_ALPHA,
      _4104: () => globalThis.WebGL2RenderingContext.FUNC_ADD,
      _4108: () => globalThis.WebGL2RenderingContext.FUNC_SUBTRACT,
      _4109: () => globalThis.WebGL2RenderingContext.FUNC_REVERSE_SUBTRACT,
      _4119: () => globalThis.WebGL2RenderingContext.ARRAY_BUFFER,
      _4120: () => globalThis.WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER,
      _4123: () => globalThis.WebGL2RenderingContext.STREAM_DRAW,
      _4124: () => globalThis.WebGL2RenderingContext.STATIC_DRAW,
      _4125: () => globalThis.WebGL2RenderingContext.DYNAMIC_DRAW,
      _4129: () => globalThis.WebGL2RenderingContext.FRONT,
      _4130: () => globalThis.WebGL2RenderingContext.BACK,
      _4132: () => globalThis.WebGL2RenderingContext.CULL_FACE,
      _4133: () => globalThis.WebGL2RenderingContext.BLEND,
      _4136: () => globalThis.WebGL2RenderingContext.DEPTH_TEST,
      _4137: () => globalThis.WebGL2RenderingContext.SCISSOR_TEST,
      _4141: () => globalThis.WebGL2RenderingContext.NO_ERROR,
      _4147: () => globalThis.WebGL2RenderingContext.CCW,
      _4178: () => globalThis.WebGL2RenderingContext.MAX_TEXTURE_SIZE,
      _4200: () => globalThis.WebGL2RenderingContext.UNSIGNED_BYTE,
      _4202: () => globalThis.WebGL2RenderingContext.UNSIGNED_SHORT,
      _4205: () => globalThis.WebGL2RenderingContext.FLOAT,
      _4209: () => globalThis.WebGL2RenderingContext.RGBA,
      _4215: () => globalThis.WebGL2RenderingContext.FRAGMENT_SHADER,
      _4216: () => globalThis.WebGL2RenderingContext.VERTEX_SHADER,
      _4217: () => globalThis.WebGL2RenderingContext.MAX_VERTEX_ATTRIBS,
      _4226: () => globalThis.WebGL2RenderingContext.LINK_STATUS,
      _4233: () => globalThis.WebGL2RenderingContext.NEVER,
      _4234: () => globalThis.WebGL2RenderingContext.LESS,
      _4236: () => globalThis.WebGL2RenderingContext.LEQUAL,
      _4240: () => globalThis.WebGL2RenderingContext.ALWAYS,
      _4248: () => globalThis.WebGL2RenderingContext.VENDOR,
      _4249: () => globalThis.WebGL2RenderingContext.RENDERER,
      _4251: () => globalThis.WebGL2RenderingContext.NEAREST,
      _4252: () => globalThis.WebGL2RenderingContext.LINEAR,
      _4256: () => globalThis.WebGL2RenderingContext.LINEAR_MIPMAP_LINEAR,
      _4257: () => globalThis.WebGL2RenderingContext.TEXTURE_MAG_FILTER,
      _4258: () => globalThis.WebGL2RenderingContext.TEXTURE_MIN_FILTER,
      _4259: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_S,
      _4260: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_T,
      _4261: () => globalThis.WebGL2RenderingContext.TEXTURE_2D,
      _4272: () => globalThis.WebGL2RenderingContext.TEXTURE0,
      _4273: () => globalThis.WebGL2RenderingContext.TEXTURE1,
      _4279: () => globalThis.WebGL2RenderingContext.TEXTURE7,
      _4280: () => globalThis.WebGL2RenderingContext.TEXTURE8,
      _4281: () => globalThis.WebGL2RenderingContext.TEXTURE9,
      _4282: () => globalThis.WebGL2RenderingContext.TEXTURE10,
      _4283: () => globalThis.WebGL2RenderingContext.TEXTURE11,
      _4305: () => globalThis.WebGL2RenderingContext.REPEAT,
      _4306: () => globalThis.WebGL2RenderingContext.CLAMP_TO_EDGE,
      _4332: () => globalThis.WebGL2RenderingContext.COMPILE_STATUS,
      _4339: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER,
      _4340: () => globalThis.WebGL2RenderingContext.RENDERBUFFER,
      _4343: () => globalThis.WebGL2RenderingContext.RGBA8,
      _4361: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT0,
      _4362: () => globalThis.WebGL2RenderingContext.DEPTH_ATTACHMENT,
      _4365: () => globalThis.WebGL2RenderingContext.NONE,
      _4366: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER_COMPLETE,
      _4375: () => globalThis.WebGL2RenderingContext.UNPACK_FLIP_Y_WEBGL,
      _4408: () => globalThis.WebGL2RenderingContext.DEPTH_COMPONENT24,
      _4462: () => globalThis.WebGL2RenderingContext.MAX_ARRAY_TEXTURE_LAYERS,
      _4466: () => globalThis.WebGL2RenderingContext.TEXTURE_2D_ARRAY,
      _4530: () => globalThis.WebGL2RenderingContext.READ_FRAMEBUFFER,
      _4531: () => globalThis.WebGL2RenderingContext.DRAW_FRAMEBUFFER,
      _4535: () => globalThis.WebGL2RenderingContext.MAX_COLOR_ATTACHMENTS,
      _4536: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT1,
      _4552: () => globalThis.WebGL2RenderingContext.MAX_SAMPLES,
      _4796: x0 => x0.canvas,
      _4797: x0 => x0.drawingBufferWidth,
      _4798: x0 => x0.drawingBufferHeight,
      _5406: x0 => x0.destination,
      _5407: x0 => x0.sampleRate,
      _5409: x0 => x0.listener,
      _5410: x0 => x0.state,
      _5527: (x0,x1) => { x0.value = x1 },
      _5563: (x0,x1) => { x0.buffer = x1 },
      _5565: x0 => x0.playbackRate,
      _5609: (x0,x1) => { x0.type = x1 },
      _5611: x0 => x0.frequency,
      _5640: (x0,x1) => { x0.buffer = x1 },
      _5675: x0 => x0.gain,
      _5720: (x0,x1) => { x0.panningModel = x1 },
      _5722: x0 => x0.positionX,
      _5723: x0 => x0.positionY,
      _5724: x0 => x0.positionZ,
      _5728: (x0,x1) => { x0.distanceModel = x1 },
      _5730: (x0,x1) => { x0.refDistance = x1 },
      _5732: (x0,x1) => { x0.maxDistance = x1 },
      _5734: (x0,x1) => { x0.rolloffFactor = x1 },
      _5736: (x0,x1) => { x0.coneInnerAngle = x1 },
      _6904: x0 => x0.type,
      _6915: x0 => x0.defaultPrevented,
      _6955: x0 => x0.length,
      _7032: (x0,x1) => { x0.textContent = x1 },
      _7037: () => globalThis.document,
      _7100: x0 => x0.documentElement,
      _7114: x0 => x0.body,
      _7150: x0 => x0.activeElement,
      _7463: (x0,x1) => { x0.className = x1 },
      _7464: x0 => x0.className,
      _7780: x0 => x0.code,
      _7783: x0 => x0.shiftKey,
      _7786: x0 => x0.repeat,
      _8551: x0 => x0.status,
      _8552: x0 => x0.ok,
      _8804: x0 => x0.matches,
      _10496: (x0,x1) => { x0.display = x1 },
      _12767: () => globalThis.console,
