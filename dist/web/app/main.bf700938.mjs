...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _386: (x0,x1,x2) => x0.setProperty(x1,x2),
      _387: (x0,x1) => x0.removeAttribute(x1),
      _388: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._388(f,arguments.length,x0) }),
      _389: x0 => x0.focus(),
      _390: (x0,x1) => x0.querySelectorAll(x1),
      _391: (x0,x1) => x0.item(x1),
      ...
      _402: (x0,x1,x2) => x0.setTimeout(x1,x2),
      _403: (x0,x1) => x0.removeItem(x1),
      ...
      _408: x0 => x0.createGain(),
      _409: x0 => x0.createConvolver(),
      _410: (x0,x1) => x0.connect(x1),
      _411: x0 => x0.createBiquadFilter(),
      _412: (x0,x1) => x0.disconnect(x1),
      _413: (x0,x1) => x0.createChannelSplitter(x1),
      _414: (x0,x1) => x0.createChannelMerger(x1),
      _415: x0 => x0.disconnect(),
      _416: (x0,x1,x2) => x0.connect(x1,x2),
      _417: (x0,x1,x2,x3) => x0.connect(x1,x2,x3),
      _418: x0 => x0.resume(),
      _419: () => new AudioContext(),
      _420: x0 => x0.arrayBuffer(),
      _421: (x0,x1) => x0.decodeAudioData(x1),
      _422: (x0,x1,x2,x3) => x0.createBuffer(x1,x2,x3),
      _423: (x0,x1,x2) => x0.copyToChannel(x1,x2),
      _424: x0 => x0.createBufferSource(),
      ...
      _428: x0 => x0.createPanner(),
      _429: (x0,x1,x2,x3) => x0.setPosition(x1,x2,x3),
      _430: (x0,x1,x2,x3,x4,x5,x6) => x0.setOrientation(x1,x2,x3,x4,x5,x6),
      _431: (x0,x1) => x0.cancelScheduledValues(x1),
      _432: (x0,x1,x2) => x0.setValueAtTime(x1,x2),
      _433: (x0,x1,x2) => x0.linearRampToValueAtTime(x1,x2),
      _435: o => o instanceof Array,
      _444: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _445: a => a.length,
      _447: (a, i) => a[i],
      _448: (a, i, v) => a[i] = v,
      _453: o => {
      ...
      _454: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _455: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _456: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _457: o => o instanceof Uint8ClampedArray,
      _458: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _459: o => o instanceof Uint16Array,
      _460: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _461: o => o instanceof Int16Array,
      _462: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _463: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _464: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _465: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _466: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _469: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _470: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _471: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _472: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _474: (t, s) => t.set(s),
      _476: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _478: o => o.buffer,
      _479: o => o.byteOffset,
      _480: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _481: (b, o) => new DataView(b, o),
      _482: (b, o, l) => new DataView(b, o, l),
      _483: Function.prototype.call.bind(DataView.prototype.getUint8),
      _484: Function.prototype.call.bind(DataView.prototype.setUint8),
      _485: Function.prototype.call.bind(DataView.prototype.getInt8),
      _486: Function.prototype.call.bind(DataView.prototype.setInt8),
      _487: Function.prototype.call.bind(DataView.prototype.getUint16),
      _488: Function.prototype.call.bind(DataView.prototype.setUint16),
      _489: Function.prototype.call.bind(DataView.prototype.getInt16),
      _490: Function.prototype.call.bind(DataView.prototype.setInt16),
      _491: Function.prototype.call.bind(DataView.prototype.getUint32),
      _492: Function.prototype.call.bind(DataView.prototype.setUint32),
      _493: Function.prototype.call.bind(DataView.prototype.getInt32),
      _494: Function.prototype.call.bind(DataView.prototype.setInt32),
      _499: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _500: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _501: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _502: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _503: Function.prototype.call.bind(Number.prototype.toString),
      _504: Function.prototype.call.bind(BigInt.prototype.toString),
      _505: Function.prototype.call.bind(Number.prototype.toString),
      _506: (d, digits) => d.toFixed(digits),
      _622: x0 => x0.style,
      _1065: (x0,x1) => { x0.src = x1 },
      _1078: x0 => x0.width,
      _1080: x0 => x0.height,
      _1081: x0 => x0.naturalWidth,
      _1082: x0 => x0.naturalHeight,
      _1569: x0 => x0.checked,
      _1592: (x0,x1) => { x0.max = x1 },
      _1596: (x0,x1) => { x0.min = x1 },
      _1616: (x0,x1) => { x0.step = x1 },
      _1618: (x0,x1) => { x0.type = x1 },
      _1622: (x0,x1) => { x0.value = x1 },
      _1623: x0 => x0.value,
      _1904: (x0,x1) => { x0.width = x1 },
      _1905: x0 => x0.width,
      _1906: (x0,x1) => { x0.height = x1 },
      _1907: x0 => x0.height,
      _2036: x0 => x0.data,
      _2265: () => globalThis.window,
      _2301: x0 => x0.innerWidth,
      _2302: x0 => x0.innerHeight,
      _2317: x0 => x0.document,
      _2320: x0 => x0.location,
      _2598: x0 => x0.localStorage,
      _2620: x0 => x0.search,
      _2770: x0 => x0.message,
      _2788: x0 => x0.reason,
      _4096: () => globalThis.WebGL2RenderingContext.DEPTH_BUFFER_BIT,
      _4098: () => globalThis.WebGL2RenderingContext.COLOR_BUFFER_BIT,
      _4103: () => globalThis.WebGL2RenderingContext.TRIANGLES,
      _4106: () => globalThis.WebGL2RenderingContext.ZERO,
      _4107: () => globalThis.WebGL2RenderingContext.ONE,
      _4110: () => globalThis.WebGL2RenderingContext.SRC_ALPHA,
      _4111: () => globalThis.WebGL2RenderingContext.ONE_MINUS_SRC_ALPHA,
      _4112: () => globalThis.WebGL2RenderingContext.DST_ALPHA,
      _4113: () => globalThis.WebGL2RenderingContext.ONE_MINUS_DST_ALPHA,
      _4117: () => globalThis.WebGL2RenderingContext.FUNC_ADD,
      _4121: () => globalThis.WebGL2RenderingContext.FUNC_SUBTRACT,
      _4122: () => globalThis.WebGL2RenderingContext.FUNC_REVERSE_SUBTRACT,
      _4132: () => globalThis.WebGL2RenderingContext.ARRAY_BUFFER,
      _4133: () => globalThis.WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER,
      _4136: () => globalThis.WebGL2RenderingContext.STREAM_DRAW,
      _4137: () => globalThis.WebGL2RenderingContext.STATIC_DRAW,
      _4138: () => globalThis.WebGL2RenderingContext.DYNAMIC_DRAW,
      _4142: () => globalThis.WebGL2RenderingContext.FRONT,
      _4143: () => globalThis.WebGL2RenderingContext.BACK,
      _4145: () => globalThis.WebGL2RenderingContext.CULL_FACE,
      _4146: () => globalThis.WebGL2RenderingContext.BLEND,
      _4149: () => globalThis.WebGL2RenderingContext.DEPTH_TEST,
      _4150: () => globalThis.WebGL2RenderingContext.SCISSOR_TEST,
      _4154: () => globalThis.WebGL2RenderingContext.NO_ERROR,
      _4160: () => globalThis.WebGL2RenderingContext.CCW,
      _4191: () => globalThis.WebGL2RenderingContext.MAX_TEXTURE_SIZE,
      _4213: () => globalThis.WebGL2RenderingContext.UNSIGNED_BYTE,
      _4215: () => globalThis.WebGL2RenderingContext.UNSIGNED_SHORT,
      _4218: () => globalThis.WebGL2RenderingContext.FLOAT,
      _4222: () => globalThis.WebGL2RenderingContext.RGBA,
      _4228: () => globalThis.WebGL2RenderingContext.FRAGMENT_SHADER,
      _4229: () => globalThis.WebGL2RenderingContext.VERTEX_SHADER,
      _4230: () => globalThis.WebGL2RenderingContext.MAX_VERTEX_ATTRIBS,
      _4239: () => globalThis.WebGL2RenderingContext.LINK_STATUS,
      _4246: () => globalThis.WebGL2RenderingContext.NEVER,
      _4247: () => globalThis.WebGL2RenderingContext.LESS,
      _4249: () => globalThis.WebGL2RenderingContext.LEQUAL,
      _4253: () => globalThis.WebGL2RenderingContext.ALWAYS,
      _4261: () => globalThis.WebGL2RenderingContext.VENDOR,
      _4262: () => globalThis.WebGL2RenderingContext.RENDERER,
      _4264: () => globalThis.WebGL2RenderingContext.NEAREST,
      _4265: () => globalThis.WebGL2RenderingContext.LINEAR,
      _4269: () => globalThis.WebGL2RenderingContext.LINEAR_MIPMAP_LINEAR,
      _4270: () => globalThis.WebGL2RenderingContext.TEXTURE_MAG_FILTER,
      _4271: () => globalThis.WebGL2RenderingContext.TEXTURE_MIN_FILTER,
      _4272: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_S,
      _4273: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_T,
      _4274: () => globalThis.WebGL2RenderingContext.TEXTURE_2D,
      _4285: () => globalThis.WebGL2RenderingContext.TEXTURE0,
      _4286: () => globalThis.WebGL2RenderingContext.TEXTURE1,
      _4292: () => globalThis.WebGL2RenderingContext.TEXTURE7,
      _4293: () => globalThis.WebGL2RenderingContext.TEXTURE8,
      _4294: () => globalThis.WebGL2RenderingContext.TEXTURE9,
      _4295: () => globalThis.WebGL2RenderingContext.TEXTURE10,
      _4296: () => globalThis.WebGL2RenderingContext.TEXTURE11,
      _4318: () => globalThis.WebGL2RenderingContext.REPEAT,
      _4319: () => globalThis.WebGL2RenderingContext.CLAMP_TO_EDGE,
      _4345: () => globalThis.WebGL2RenderingContext.COMPILE_STATUS,
      _4352: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER,
      _4353: () => globalThis.WebGL2RenderingContext.RENDERBUFFER,
      _4356: () => globalThis.WebGL2RenderingContext.RGBA8,
      _4374: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT0,
      _4375: () => globalThis.WebGL2RenderingContext.DEPTH_ATTACHMENT,
      _4378: () => globalThis.WebGL2RenderingContext.NONE,
      _4379: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER_COMPLETE,
      _4388: () => globalThis.WebGL2RenderingContext.UNPACK_FLIP_Y_WEBGL,
      _4421: () => globalThis.WebGL2RenderingContext.DEPTH_COMPONENT24,
      _4475: () => globalThis.WebGL2RenderingContext.MAX_ARRAY_TEXTURE_LAYERS,
      _4479: () => globalThis.WebGL2RenderingContext.TEXTURE_2D_ARRAY,
      _4543: () => globalThis.WebGL2RenderingContext.READ_FRAMEBUFFER,
      _4544: () => globalThis.WebGL2RenderingContext.DRAW_FRAMEBUFFER,
      _4548: () => globalThis.WebGL2RenderingContext.MAX_COLOR_ATTACHMENTS,
      _4549: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT1,
      _4565: () => globalThis.WebGL2RenderingContext.MAX_SAMPLES,
      _4809: x0 => x0.canvas,
      _4810: x0 => x0.drawingBufferWidth,
      _4811: x0 => x0.drawingBufferHeight,
      _5417: x0 => x0.destination,
      _5418: x0 => x0.sampleRate,
      _5419: x0 => x0.currentTime,
      _5420: x0 => x0.listener,
      _5421: x0 => x0.state,
      _5537: (x0,x1) => { x0.value = x1 },
      _5538: x0 => x0.value,
      _5546: (x0,x1) => { x0.onended = x1 },
      _5573: (x0,x1) => { x0.buffer = x1 },
      _5575: x0 => x0.playbackRate,
      _5619: (x0,x1) => { x0.type = x1 },
      _5621: x0 => x0.frequency,
      _5650: (x0,x1) => { x0.buffer = x1 },
      _5685: x0 => x0.gain,
      _5730: (x0,x1) => { x0.panningModel = x1 },
      _5732: x0 => x0.positionX,
      _5733: x0 => x0.positionY,
      _5734: x0 => x0.positionZ,
      _5738: (x0,x1) => { x0.distanceModel = x1 },
      _5740: (x0,x1) => { x0.refDistance = x1 },
      _5742: (x0,x1) => { x0.maxDistance = x1 },
      _5744: (x0,x1) => { x0.rolloffFactor = x1 },
      _5746: (x0,x1) => { x0.coneInnerAngle = x1 },
      _6914: x0 => x0.type,
      _6925: x0 => x0.defaultPrevented,
      _6965: x0 => x0.length,
      _7042: (x0,x1) => { x0.textContent = x1 },
      _7047: () => globalThis.document,
      _7110: x0 => x0.documentElement,
      _7124: x0 => x0.body,
      _7160: x0 => x0.activeElement,
      _7470: (x0,x1) => { x0.id = x1 },
      _7472: (x0,x1) => { x0.className = x1 },
      _7473: x0 => x0.className,
      _7789: x0 => x0.code,
      _7792: x0 => x0.shiftKey,
      _7795: x0 => x0.repeat,
      _8560: x0 => x0.status,
      _8561: x0 => x0.ok,
      _8813: x0 => x0.matches,
      _10505: (x0,x1) => { x0.display = x1 },
      _10506: x0 => x0.display,
      _12776: () => globalThis.console,
