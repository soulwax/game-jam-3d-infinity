...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _436: o => o instanceof Array,
      _445: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _446: a => a.length,
      _448: (a, i) => a[i],
      _449: (a, i, v) => a[i] = v,
      _454: o => {
      ...
      _455: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _456: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _457: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _458: o => o instanceof Uint8ClampedArray,
      _459: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _460: o => o instanceof Uint16Array,
      _461: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _462: o => o instanceof Int16Array,
      _463: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _464: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _465: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _466: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _467: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _470: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _471: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _472: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _473: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _475: (t, s) => t.set(s),
      _477: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _479: o => o.buffer,
      _480: o => o.byteOffset,
      _481: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _482: (b, o) => new DataView(b, o),
      _483: (b, o, l) => new DataView(b, o, l),
      _484: Function.prototype.call.bind(DataView.prototype.getUint8),
      _485: Function.prototype.call.bind(DataView.prototype.setUint8),
      _486: Function.prototype.call.bind(DataView.prototype.getInt8),
      _487: Function.prototype.call.bind(DataView.prototype.setInt8),
      _488: Function.prototype.call.bind(DataView.prototype.getUint16),
      _489: Function.prototype.call.bind(DataView.prototype.setUint16),
      _490: Function.prototype.call.bind(DataView.prototype.getInt16),
      _491: Function.prototype.call.bind(DataView.prototype.setInt16),
      _492: Function.prototype.call.bind(DataView.prototype.getUint32),
      _493: Function.prototype.call.bind(DataView.prototype.setUint32),
      _494: Function.prototype.call.bind(DataView.prototype.getInt32),
      _495: Function.prototype.call.bind(DataView.prototype.setInt32),
      _500: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _501: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _502: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _503: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _504: Function.prototype.call.bind(Number.prototype.toString),
      _505: Function.prototype.call.bind(BigInt.prototype.toString),
      _506: Function.prototype.call.bind(Number.prototype.toString),
      _507: (d, digits) => d.toFixed(digits),
      _623: x0 => x0.style,
      _1066: (x0,x1) => { x0.src = x1 },
      _1079: x0 => x0.width,
      _1081: x0 => x0.height,
      ...
      _1617: (x0,x1) => { x0.step = x1 },
      _1619: (x0,x1) => { x0.type = x1 },
      _1623: (x0,x1) => { x0.value = x1 },
      _1624: x0 => x0.value,
      _1905: (x0,x1) => { x0.width = x1 },
      _1906: x0 => x0.width,
      _1907: (x0,x1) => { x0.height = x1 },
      _1908: x0 => x0.height,
      _2037: x0 => x0.data,
      _2266: () => globalThis.window,
      _2302: x0 => x0.innerWidth,
      _2303: x0 => x0.innerHeight,
      _2318: x0 => x0.document,
      _2321: x0 => x0.location,
      _2599: x0 => x0.localStorage,
      _2621: x0 => x0.search,
      _2771: x0 => x0.message,
      _2789: x0 => x0.reason,
      _4097: () => globalThis.WebGL2RenderingContext.DEPTH_BUFFER_BIT,
      _4099: () => globalThis.WebGL2RenderingContext.COLOR_BUFFER_BIT,
      _4104: () => globalThis.WebGL2RenderingContext.TRIANGLES,
      _4107: () => globalThis.WebGL2RenderingContext.ZERO,
      _4108: () => globalThis.WebGL2RenderingContext.ONE,
      _4111: () => globalThis.WebGL2RenderingContext.SRC_ALPHA,
      _4112: () => globalThis.WebGL2RenderingContext.ONE_MINUS_SRC_ALPHA,
      _4113: () => globalThis.WebGL2RenderingContext.DST_ALPHA,
      _4114: () => globalThis.WebGL2RenderingContext.ONE_MINUS_DST_ALPHA,
      _4118: () => globalThis.WebGL2RenderingContext.FUNC_ADD,
      _4122: () => globalThis.WebGL2RenderingContext.FUNC_SUBTRACT,
      _4123: () => globalThis.WebGL2RenderingContext.FUNC_REVERSE_SUBTRACT,
      _4133: () => globalThis.WebGL2RenderingContext.ARRAY_BUFFER,
      _4134: () => globalThis.WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER,
      _4137: () => globalThis.WebGL2RenderingContext.STREAM_DRAW,
      _4138: () => globalThis.WebGL2RenderingContext.STATIC_DRAW,
      _4139: () => globalThis.WebGL2RenderingContext.DYNAMIC_DRAW,
      _4143: () => globalThis.WebGL2RenderingContext.FRONT,
      _4144: () => globalThis.WebGL2RenderingContext.BACK,
      _4146: () => globalThis.WebGL2RenderingContext.CULL_FACE,
      _4147: () => globalThis.WebGL2RenderingContext.BLEND,
      _4150: () => globalThis.WebGL2RenderingContext.DEPTH_TEST,
      _4151: () => globalThis.WebGL2RenderingContext.SCISSOR_TEST,
      _4155: () => globalThis.WebGL2RenderingContext.NO_ERROR,
      _4161: () => globalThis.WebGL2RenderingContext.CCW,
      _4192: () => globalThis.WebGL2RenderingContext.MAX_TEXTURE_SIZE,
      _4214: () => globalThis.WebGL2RenderingContext.UNSIGNED_BYTE,
      _4216: () => globalThis.WebGL2RenderingContext.UNSIGNED_SHORT,
      _4219: () => globalThis.WebGL2RenderingContext.FLOAT,
      _4223: () => globalThis.WebGL2RenderingContext.RGBA,
      _4229: () => globalThis.WebGL2RenderingContext.FRAGMENT_SHADER,
      _4230: () => globalThis.WebGL2RenderingContext.VERTEX_SHADER,
      _4231: () => globalThis.WebGL2RenderingContext.MAX_VERTEX_ATTRIBS,
      _4240: () => globalThis.WebGL2RenderingContext.LINK_STATUS,
      _4247: () => globalThis.WebGL2RenderingContext.NEVER,
      _4248: () => globalThis.WebGL2RenderingContext.LESS,
      _4250: () => globalThis.WebGL2RenderingContext.LEQUAL,
      _4254: () => globalThis.WebGL2RenderingContext.ALWAYS,
      _4262: () => globalThis.WebGL2RenderingContext.VENDOR,
      _4263: () => globalThis.WebGL2RenderingContext.RENDERER,
      _4265: () => globalThis.WebGL2RenderingContext.NEAREST,
      _4266: () => globalThis.WebGL2RenderingContext.LINEAR,
      _4270: () => globalThis.WebGL2RenderingContext.LINEAR_MIPMAP_LINEAR,
      _4271: () => globalThis.WebGL2RenderingContext.TEXTURE_MAG_FILTER,
      _4272: () => globalThis.WebGL2RenderingContext.TEXTURE_MIN_FILTER,
      _4273: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_S,
      _4274: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_T,
      _4275: () => globalThis.WebGL2RenderingContext.TEXTURE_2D,
      _4286: () => globalThis.WebGL2RenderingContext.TEXTURE0,
      _4287: () => globalThis.WebGL2RenderingContext.TEXTURE1,
      _4293: () => globalThis.WebGL2RenderingContext.TEXTURE7,
      _4294: () => globalThis.WebGL2RenderingContext.TEXTURE8,
      _4295: () => globalThis.WebGL2RenderingContext.TEXTURE9,
      _4296: () => globalThis.WebGL2RenderingContext.TEXTURE10,
      _4297: () => globalThis.WebGL2RenderingContext.TEXTURE11,
      _4319: () => globalThis.WebGL2RenderingContext.REPEAT,
      _4320: () => globalThis.WebGL2RenderingContext.CLAMP_TO_EDGE,
      _4346: () => globalThis.WebGL2RenderingContext.COMPILE_STATUS,
      _4353: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER,
      _4354: () => globalThis.WebGL2RenderingContext.RENDERBUFFER,
      _4357: () => globalThis.WebGL2RenderingContext.RGBA8,
      _4375: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT0,
      _4376: () => globalThis.WebGL2RenderingContext.DEPTH_ATTACHMENT,
      _4379: () => globalThis.WebGL2RenderingContext.NONE,
      _4380: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER_COMPLETE,
      _4389: () => globalThis.WebGL2RenderingContext.UNPACK_FLIP_Y_WEBGL,
      _4422: () => globalThis.WebGL2RenderingContext.DEPTH_COMPONENT24,
      _4476: () => globalThis.WebGL2RenderingContext.MAX_ARRAY_TEXTURE_LAYERS,
      _4480: () => globalThis.WebGL2RenderingContext.TEXTURE_2D_ARRAY,
      _4544: () => globalThis.WebGL2RenderingContext.READ_FRAMEBUFFER,
      _4545: () => globalThis.WebGL2RenderingContext.DRAW_FRAMEBUFFER,
      _4549: () => globalThis.WebGL2RenderingContext.MAX_COLOR_ATTACHMENTS,
      _4550: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT1,
      _4566: () => globalThis.WebGL2RenderingContext.MAX_SAMPLES,
      _4810: x0 => x0.canvas,
      _4811: x0 => x0.drawingBufferWidth,
      _4812: x0 => x0.drawingBufferHeight,
      _5418: x0 => x0.destination,
      _5419: x0 => x0.sampleRate,
      _5420: x0 => x0.currentTime,
      _5421: x0 => x0.listener,
      _5422: x0 => x0.state,
      _5538: (x0,x1) => { x0.value = x1 },
      _5539: x0 => x0.value,
      _5547: (x0,x1) => { x0.onended = x1 },
      _5574: (x0,x1) => { x0.buffer = x1 },
      _5576: x0 => x0.playbackRate,
      _5578: (x0,x1) => { x0.loop = x1 },
      _5620: (x0,x1) => { x0.type = x1 },
      _5622: x0 => x0.frequency,
      _5651: (x0,x1) => { x0.buffer = x1 },
      _5686: x0 => x0.gain,
      _5731: (x0,x1) => { x0.panningModel = x1 },
      _5733: x0 => x0.positionX,
      _5734: x0 => x0.positionY,
      _5735: x0 => x0.positionZ,
      _5739: (x0,x1) => { x0.distanceModel = x1 },
      _5741: (x0,x1) => { x0.refDistance = x1 },
      _5743: (x0,x1) => { x0.maxDistance = x1 },
      _5745: (x0,x1) => { x0.rolloffFactor = x1 },
      _5747: (x0,x1) => { x0.coneInnerAngle = x1 },
      _6915: x0 => x0.type,
      _6926: x0 => x0.defaultPrevented,
      _6966: x0 => x0.length,
      _7043: (x0,x1) => { x0.textContent = x1 },
      _7048: () => globalThis.document,
      _7111: x0 => x0.documentElement,
      _7125: x0 => x0.body,
      _7161: x0 => x0.activeElement,
      _7471: (x0,x1) => { x0.id = x1 },
      _7473: (x0,x1) => { x0.className = x1 },
      _7474: x0 => x0.className,
      _7790: x0 => x0.code,
      _7793: x0 => x0.shiftKey,
      _7796: x0 => x0.repeat,
      _8561: x0 => x0.status,
      _8562: x0 => x0.ok,
      _8814: x0 => x0.matches,
      _10506: (x0,x1) => { x0.display = x1 },
      _10507: x0 => x0.display,
      _12777: () => globalThis.console,
