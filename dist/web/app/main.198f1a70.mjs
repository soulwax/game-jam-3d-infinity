...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: x0 => x0.getSupportedExtensions(),
      ...
      qJ: () => globalThis.WebGL2RenderingContext.VENDOR,
      ...
      rJ: () => globalThis.WebGL2RenderingContext.RENDERER,
      s: (l, r) => l === r,
      sB: o => {
        if (o === undefined || o === null) return 0;
      ...
      sJ: () => globalThis.WebGL2RenderingContext.MAX_COLOR_ATTACHMENTS,
      ...
      tJ: () => globalThis.WebGL2RenderingContext.MAX_VERTEX_ATTRIBS,
      ...
      uJ: () => globalThis.WebGL2RenderingContext.MAX_SAMPLES,
      ...
      vJ: () => globalThis.WebGL2RenderingContext.MAX_ARRAY_TEXTURE_LAYERS,
      ...
      wJ: () => globalThis.WebGL2RenderingContext.MAX_TEXTURE_SIZE,
