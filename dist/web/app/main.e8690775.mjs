...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _478: x0 => x0.createPanner(),
      _479: (x0,x1,x2,x3) => x0.setPosition(x1,x2,x3),
      _480: (x0,x1,x2,x3,x4,x5,x6) => x0.setOrientation(x1,x2,x3,x4,x5,x6),
      _481: (x0,x1) => x0.cancelScheduledValues(x1),
      _482: (x0,x1,x2) => x0.setValueAtTime(x1,x2),
      _483: (x0,x1,x2) => x0.linearRampToValueAtTime(x1,x2),
      ...
      _5718: x0 => x0.gain,
      _5763: (x0,x1) => { x0.panningModel = x1 },
      _5765: x0 => x0.positionX,
      _5766: x0 => x0.positionY,
      _5767: x0 => x0.positionZ,
      _5771: (x0,x1) => { x0.distanceModel = x1 },
      _5773: (x0,x1) => { x0.refDistance = x1 },
      _5775: (x0,x1) => { x0.maxDistance = x1 },
      _5777: (x0,x1) => { x0.rolloffFactor = x1 },
      _5779: (x0,x1) => { x0.coneInnerAngle = x1 },
      _6947: x0 => x0.type,
