...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _308: x0 => x0.decode(),
      _309: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _310: (x0,x1,x2,x3,x4) => x0.getImageData(x1,x2,x3,x4),
      _311: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      _414: x0 => x0.start(),
      _420: o => o instanceof Array,
      _429: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _430: a => a.length,
      _432: (a, i) => a[i],
      _433: (a, i, v) => a[i] = v,
      _438: o => {
      ...
      _439: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _440: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _441: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _442: o => o instanceof Uint8ClampedArray,
      _443: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _444: o => o instanceof Uint16Array,
      _445: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _446: o => o instanceof Int16Array,
      _447: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _448: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _449: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _450: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _451: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _454: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _455: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _456: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _457: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _459: (t, s) => t.set(s),
      _461: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _463: o => o.buffer,
      _464: o => o.byteOffset,
      _465: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _466: (b, o) => new DataView(b, o),
      _467: (b, o, l) => new DataView(b, o, l),
      _468: Function.prototype.call.bind(DataView.prototype.getUint8),
      _469: Function.prototype.call.bind(DataView.prototype.setUint8),
      _470: Function.prototype.call.bind(DataView.prototype.getInt8),
      _471: Function.prototype.call.bind(DataView.prototype.setInt8),
      _472: Function.prototype.call.bind(DataView.prototype.getUint16),
      _473: Function.prototype.call.bind(DataView.prototype.setUint16),
      _474: Function.prototype.call.bind(DataView.prototype.getInt16),
      _475: Function.prototype.call.bind(DataView.prototype.setInt16),
      _476: Function.prototype.call.bind(DataView.prototype.getUint32),
      _477: Function.prototype.call.bind(DataView.prototype.setUint32),
      _478: Function.prototype.call.bind(DataView.prototype.getInt32),
      _479: Function.prototype.call.bind(DataView.prototype.setInt32),
      _484: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _485: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _486: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _487: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _488: Function.prototype.call.bind(Number.prototype.toString),
      _489: Function.prototype.call.bind(BigInt.prototype.toString),
      _490: Function.prototype.call.bind(Number.prototype.toString),
      _491: (d, digits) => d.toFixed(digits),
      _607: x0 => x0.style,
      _1050: (x0,x1) => { x0.src = x1 },
      _1063: x0 => x0.width,
      _1065: x0 => x0.height,
      _1066: x0 => x0.naturalWidth,
      _1067: x0 => x0.naturalHeight,
      _1889: (x0,x1) => { x0.width = x1 },
      _1890: x0 => x0.width,
      _1891: (x0,x1) => { x0.height = x1 },
      _1892: x0 => x0.height,
      _2021: x0 => x0.data,
      _2250: () => globalThis.window,
      _2286: x0 => x0.innerWidth,
      _2287: x0 => x0.innerHeight,
      _2302: x0 => x0.document,
      _2305: x0 => x0.location,
      _2583: x0 => x0.localStorage,
      _2605: x0 => x0.search,
      _2755: x0 => x0.message,
      _2773: x0 => x0.reason,
      _4081: () => globalThis.WebGL2RenderingContext.DEPTH_BUFFER_BIT,
      _4083: () => globalThis.WebGL2RenderingContext.COLOR_BUFFER_BIT,
      _4088: () => globalThis.WebGL2RenderingContext.TRIANGLES,
      _4091: () => globalThis.WebGL2RenderingContext.ZERO,
      _4092: () => globalThis.WebGL2RenderingContext.ONE,
      _4095: () => globalThis.WebGL2RenderingContext.SRC_ALPHA,
      _4096: () => globalThis.WebGL2RenderingContext.ONE_MINUS_SRC_ALPHA,
      _4097: () => globalThis.WebGL2RenderingContext.DST_ALPHA,
      _4098: () => globalThis.WebGL2RenderingContext.ONE_MINUS_DST_ALPHA,
      _4102: () => globalThis.WebGL2RenderingContext.FUNC_ADD,
      _4106: () => globalThis.WebGL2RenderingContext.FUNC_SUBTRACT,
      _4107: () => globalThis.WebGL2RenderingContext.FUNC_REVERSE_SUBTRACT,
      _4117: () => globalThis.WebGL2RenderingContext.ARRAY_BUFFER,
      _4118: () => globalThis.WebGL2RenderingContext.ELEMENT_ARRAY_BUFFER,
      _4121: () => globalThis.WebGL2RenderingContext.STREAM_DRAW,
      _4122: () => globalThis.WebGL2RenderingContext.STATIC_DRAW,
      _4123: () => globalThis.WebGL2RenderingContext.DYNAMIC_DRAW,
      _4127: () => globalThis.WebGL2RenderingContext.FRONT,
      _4128: () => globalThis.WebGL2RenderingContext.BACK,
      _4130: () => globalThis.WebGL2RenderingContext.CULL_FACE,
      _4131: () => globalThis.WebGL2RenderingContext.BLEND,
      _4134: () => globalThis.WebGL2RenderingContext.DEPTH_TEST,
      _4135: () => globalThis.WebGL2RenderingContext.SCISSOR_TEST,
      _4139: () => globalThis.WebGL2RenderingContext.NO_ERROR,
      _4145: () => globalThis.WebGL2RenderingContext.CCW,
      _4176: () => globalThis.WebGL2RenderingContext.MAX_TEXTURE_SIZE,
      _4198: () => globalThis.WebGL2RenderingContext.UNSIGNED_BYTE,
      _4200: () => globalThis.WebGL2RenderingContext.UNSIGNED_SHORT,
      _4203: () => globalThis.WebGL2RenderingContext.FLOAT,
      _4207: () => globalThis.WebGL2RenderingContext.RGBA,
      _4213: () => globalThis.WebGL2RenderingContext.FRAGMENT_SHADER,
      _4214: () => globalThis.WebGL2RenderingContext.VERTEX_SHADER,
      _4215: () => globalThis.WebGL2RenderingContext.MAX_VERTEX_ATTRIBS,
      _4224: () => globalThis.WebGL2RenderingContext.LINK_STATUS,
      _4231: () => globalThis.WebGL2RenderingContext.NEVER,
      _4232: () => globalThis.WebGL2RenderingContext.LESS,
      _4234: () => globalThis.WebGL2RenderingContext.LEQUAL,
      _4238: () => globalThis.WebGL2RenderingContext.ALWAYS,
      _4246: () => globalThis.WebGL2RenderingContext.VENDOR,
      _4247: () => globalThis.WebGL2RenderingContext.RENDERER,
      _4249: () => globalThis.WebGL2RenderingContext.NEAREST,
      _4250: () => globalThis.WebGL2RenderingContext.LINEAR,
      _4254: () => globalThis.WebGL2RenderingContext.LINEAR_MIPMAP_LINEAR,
      _4255: () => globalThis.WebGL2RenderingContext.TEXTURE_MAG_FILTER,
      _4256: () => globalThis.WebGL2RenderingContext.TEXTURE_MIN_FILTER,
      _4257: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_S,
      _4258: () => globalThis.WebGL2RenderingContext.TEXTURE_WRAP_T,
      _4259: () => globalThis.WebGL2RenderingContext.TEXTURE_2D,
      _4270: () => globalThis.WebGL2RenderingContext.TEXTURE0,
      _4271: () => globalThis.WebGL2RenderingContext.TEXTURE1,
      _4277: () => globalThis.WebGL2RenderingContext.TEXTURE7,
      _4278: () => globalThis.WebGL2RenderingContext.TEXTURE8,
      _4279: () => globalThis.WebGL2RenderingContext.TEXTURE9,
      _4280: () => globalThis.WebGL2RenderingContext.TEXTURE10,
      _4281: () => globalThis.WebGL2RenderingContext.TEXTURE11,
      _4303: () => globalThis.WebGL2RenderingContext.REPEAT,
      _4304: () => globalThis.WebGL2RenderingContext.CLAMP_TO_EDGE,
      _4330: () => globalThis.WebGL2RenderingContext.COMPILE_STATUS,
      _4337: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER,
      _4338: () => globalThis.WebGL2RenderingContext.RENDERBUFFER,
      _4341: () => globalThis.WebGL2RenderingContext.RGBA8,
      _4359: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT0,
      _4360: () => globalThis.WebGL2RenderingContext.DEPTH_ATTACHMENT,
      _4363: () => globalThis.WebGL2RenderingContext.NONE,
      _4364: () => globalThis.WebGL2RenderingContext.FRAMEBUFFER_COMPLETE,
      _4373: () => globalThis.WebGL2RenderingContext.UNPACK_FLIP_Y_WEBGL,
      _4406: () => globalThis.WebGL2RenderingContext.DEPTH_COMPONENT24,
      _4460: () => globalThis.WebGL2RenderingContext.MAX_ARRAY_TEXTURE_LAYERS,
      _4464: () => globalThis.WebGL2RenderingContext.TEXTURE_2D_ARRAY,
      _4528: () => globalThis.WebGL2RenderingContext.READ_FRAMEBUFFER,
      _4529: () => globalThis.WebGL2RenderingContext.DRAW_FRAMEBUFFER,
      _4533: () => globalThis.WebGL2RenderingContext.MAX_COLOR_ATTACHMENTS,
      _4534: () => globalThis.WebGL2RenderingContext.COLOR_ATTACHMENT1,
      _4550: () => globalThis.WebGL2RenderingContext.MAX_SAMPLES,
      _4794: x0 => x0.canvas,
      _4795: x0 => x0.drawingBufferWidth,
      _4796: x0 => x0.drawingBufferHeight,
      _5404: x0 => x0.destination,
      _5405: x0 => x0.sampleRate,
      _5408: x0 => x0.state,
      _5525: (x0,x1) => { x0.value = x1 },
      _5561: (x0,x1) => { x0.buffer = x1 },
      _5563: x0 => x0.playbackRate,
