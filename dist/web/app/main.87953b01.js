...
return A.yk(a)},
d3(a,b){if(t.U.b(b))if(b.$thrownJsError==null)b.$thrownJsError=a
return b},
...
bO(a){return A.ce(A.oi(v.typeUniverse,a,!1))},
xH(a){var s=this
s.b=A.yc(s)
return s.b(a)},
yc(a){var s,r,q,p,o
...
else if(b===t.c||b===t.w)return t.gK}r=new A.bV(null,null)
r.w=7
r.x=b
r.as=c
return A.cZ(a,r)},
...
if(n===0){n=f
n.bR(A.f([],b.i("r<0>")))
return n}i.a=A.c2(n,null,!1,b.i("0?"))}catch(l){p=A.ad(l)
o=A.cf(l)
if(i.b===0||g){n=f
m=p
k=o
...
a.stack=b.n(0)
throw a},
c2(a,b,c,d){var s,r=c?J.rb(a,d):J.ra(a,d)
...
r=s.a
return r.charCodeAt(0)==0?r:r},
xW(a,b){var s,r,q,p,o,n,m,l=a.gu(a),k=0,j=0
...
else if(s===32)return A.rE(B.b.B(a5,5,a4),0,a3).ghS()}r=A.c2(8,0,!1,t.S)
B.a.l(r,0,0)
B.a.l(r,1,-1)
B.a.l(r,2,-1)
B.a.l(r,7,-1)
...
_.x=f
_.y=g},
vE(){return new A.ig(new A.c5(new A.mi(),A.f([],t.dz),A.f([],t.t),t.kk))},
...
vF(a){return new A.mk(a,new A.c5(new A.ml(),A.f([],t.jk),A.f([],t.t),t.ll),A.x(t.S,t.mL))},
...
ml:function ml(){},
mm:function mm(){},
w9(a){var s=new A.iP(a,new A.c5(new A.nq(),A.f([],t.mQ),A.f([],t.t),t.ox),A.x(t.S,t._))
s.d=s.eq()
return s},
...
this.b=b},
w_(a){return new A.fn(a,new A.c5(new A.mQ(),A.f([],t.n_),A.f([],t.t),t.mo))},
...
else B.a.k(p,new A.as(new A.ba(B.fk,i.b,i.a,h),j,n))}g=new A.ji(A.yA(A.zc(p)),A.zb(o),r,a5.b,a5.c)
f=new A.hH(a3.a)
...
_.c=c
_.d=d},
ry(a){var s=A.rm(B.F,B.a5,Math.abs(0)<0.99?B.h6:B.F)
...
r.l(0,o,A.tn(a.h(0,o)))}return A.ch(r,t.N,s)},
tn(a){var s
...
s.l(0,p,A.tm(a.h(0,p)))}return A.ch(s,t.N,o)},
tm(a){var s,r,q,p
...
xs(a,a0,a1,a2){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b
...
xz(a,b,c){var s,r,q,p,o,n,m,l,k,j,i=b.e.h(0,"hall")
i.toString
...
d=e+0.075
if(m<d)d=m
if(o>0)A.cd(a9,b0,b1,b2,j,o,f,d,0.04,p)
if(i<b3)A.cd(a9,b0,b1,b2,i,h,f,d,0.04,p)
if(e<a8)A.cd(a9,b0,b1,b2,j,h,e,d,0.04,p)
if(g>0){o=g-0.075
A.cd(a9,b0,b1,b2,j,h,0>o?0:o,g,0.065,p)}}for(a8=b0.e,r=A.K(a8),o=r.i("t(1)").a(new A.or(b2)),a8=B.a.gu(a8),r=new A.M(a8,o,r.i("M<1>")),o=b1.c,i=b2!==B.i,e=b2===B.k,c=b1.a;r.m();){b=a8.gp()
a=b.c
a0=a+b.e
a1=b.d
a2=a1+b.f
...
a3=b?10788240:p
a4=(a+a0)*0.5
A.cd(a9,b0,b1,b2,a4-0.0175,a4+0.0175,a1,a2,0.032,a3)
a4=(a1+a2)*0.5
A.cd(a9,b0,b1,b2,a,a0,a4-0.0175,a4+0.0175,0.032,a3)
a5=!i||e?0.11:0.14
a4=a-0.07
if(0>a4)a4=0
a6=!i||e?c:o
...
a6=a6<a7?a6:a7
a7=a1-0.055
A.cd(a9,b0,b1,b2,a4,a6,0.018>a7?0.018:a7,a1,a5,p)
if(b)A.cd(a9,b0,b1,b2,a+0.05,a0-0.05,a1+0.06,a1+0.09,0.025,13683904)}},
...
x7(a,b,c){var s,r,q,p,o,n,m,l,k=b.d,j=k.a,i=c.a,h=j+i*0.5,g=k.c,f=c.c,e=g+f*0.5
k=k.b
s=k+c.b
r=b.a
q=r==="living-room"
...
cd(a,b,c,d,e,f,g,h,i,j){var s=b.d,r=s.a,q=s.b,p=s.c
...
o=r-0.05
n=d+0.035
A.cd(a7,a8,a9,a,b,a3,a5,o<n?o:n,0.16,4209719)
if(a6){b=a0+0.1
a1=a0+a1-0.08
b=b>a1?b:a1
A.cd(a7,a8,a9,a,a0+0.08,b,0.16,0.25,0.13,4209719)}},
...
return new A.c1(r,q,new A.lU(A.jX(s.h(0,"min"),"bounds.min"),A.jX(s.h(0,"max"),"bounds.max")))},
...
for(s=A.tD(m.h(0,"cues"),"sound emitter cues").gO(),s=s.gu(s);s.m();){r=s.gp()
q=r.b
...
return new A.c0(s,r,p,o,n,A.ch(k,l,l))},
...
return new A.lK(e,f,c,a,A.ch(A.aX(d,s,s),s,s),A.am(b,s))},
...
this.b=b
this.c=c},
mW(a,b,c,d,e){var s="406b7136876f-08daacb75415-dirty",r=A.oy("RENDERER_SHA"),q=A.oy("GAME_SHA"),p=A.oy("DART_SDK_VERSION"),o=A.oy("LOCKFILE_SHA256"),n=A.me(b,A.K(b).c)
n=A.L(n,A.o(n).c)
B.a.a0(n)
...
h=i.a
if(h<1||h>21)return new A.bf(new A.bv(B.hq,k+" has an out-of-range authored day "+h+"."))
g=A.wi(k,h,i.b,m)
...
if(g==null||g<1||i.b.length===0)return new A.bf(new A.bv(B.hr,a+" day "+s+" has malformed "+n+" tier data."))
f=a1.h(0,r+h)
if(f==null)f=B.bo
...
for(q=r.b.gal(),q=q.gu(q);q.m();)if(q.gp().gS().R(0,new A.p9())){p.k(0,r.a)
...
a9=t.p9
b0=t.fP
b1=new A.fU(n,A.a($.C.j().width),A.a($.C.j().height),A.f([],a6),A.x(a7,t.l0),A.f([],t.jj),A.x(a7,a8),A.x(a7,a9),A.x(a7,a8),A.x(a7,a9),A.f([],a6),A.f([],t.jU),B.er,A.x(a7,t.lu),A.x(a7,b0),A.x(a7,b0),B.dz,B.fl)}else b1=new A.er(n,A.a($.C.j().width),A.a($.C.j().height),A.nw().gbJ().h(0,"render")==="legacy",$.bh.j().d,$.bh.j().e)
m=b1
...
a4=A.K(a3)
a5=a4.i("S<1,c1>")
a3=A.L(new A.S(a3,a4.i("c1(1)").a(A.yY()),a5),a5.i("a2.E"))
a3.$flags=1
a=b.h(0,"placements")
...
a8=A.K(a7)
a9=a8.i("S<1,c0>")
a7=A.L(new A.S(a7,a8.i("c0(1)").a(A.zd()),a9),a9.i("a2.E"))
a7.$flags=1
...
d.i5($.aK)
for(e=$.cc.length,a=0;a<$.cc.length;$.cc.length===e||(0,A.p)($.cc),++a){k=$.cc[a]
A.xr(l,k)}B.a.H($.cc)
...
n(a){return A.pK(a,"[","]")},
gu(a){return new J.d4(a,a.length,A.K(a).i("d4<1>"))},
gG(a){return A.fl(a)},
...
s=l-o
if(s<=0){n=p.$ti.c
return b?J.rb(0,n):J.ra(0,n)}r=A.c2(s,m.T(n,o),b,p.$ti.c)
...
$iaf:1}
A.cn.prototype={
gu(a){return new A.dn(J.O(this.a),this.b,A.o(this).i("dn<1,2>"))},
...
T(a,b){return this.b.$1(J.k4(this.a,b))}}
A.R.prototype={
gu(a){return new A.M(J.O(this.a),this.b,this.$ti.i("M<1>"))}}
A.M.prototype={
m(){var s,r
...
s.y[1].a(c)
A.uU()},
gO(){return new A.cb(this.kJ(),A.o(this).i("cb<P<1,2>>"))},
kJ(){var s=this
...
return A.ce(s==null?A.bk(this):s)},
$idd:1,
glW(){return this},
$C:"$1",
$R:1,
...
gu(a){var s=this,r=new A.dL(s,s.r,A.o(s).i("dL<1>"))
r.c=s.e
return r},
gq(a){return this.a},
gI(a){return this.a===0},
...
if(r==null)return!1
return t.Y.a(r[b])!=null}else return this.j5(b)},
j5(a){var s=this.d
if(s==null)return!1
...
n=Object.keys(a)
m=[]
for(s=J.bZ(n),p=s.gu(n);p.m();)m.push(A.cD(p.gp()))
...
A.mi.prototype={
$3(a,b,c){return new A.c3(A.a(a),A.a(b),A.bz(c))},
$S:69}
A.iT.prototype={}
A.mk.prototype={
...
A.mK.prototype={
kj(a,b){var s=this.jZ(t.T.a(a),!1),r=this.a,q=A.K(r)
...
gdH(){return new A.cb(this.l5(),t.fJ)},
l5(){var s=this
...
d=A.K(f)
r=5
return a.b=new A.dI(h,g,A.cg(new A.S(f,d.i("z(1)").a(i.gb1()),d.i("S<1,z>")))),1
case 5:r=3
break
...
hN(a,b,c){var s
if(this.r)A.k(A.l("resource library is disposed"))
s=this.c.b.aT(new A.cy(new A.hV(c,b,1,!1,B.Y,B.Y,B.b9),A.c2(1,null,!1,t.nh),!1),a)
this.f.k(0,s)
return s},
...
aa(a){var s=this,r=s.a.ag(new A.aQ(s.e,s.b,s.c,B.q,B.bv,B.br)),q=A.ca(s.d),p=t.n,o=s.y,n=s.r===B.ch?new Float32Array(A.a3(A.f([1/o.c,0],p))):new Float32Array(A.a3(A.f([0,1/o.d],p)))
...
aa(a){var s=this,r="bloomComposite",q=s.a.ag(new A.aQ(r,s.b,s.c,B.q,B.eS,B.eE)),p=A.ca(s.d)
...
aa(a){var s=this,r=s.a.ag(new A.aQ(s.e,s.b,s.c,B.q,B.bv,B.br)),q=A.ca(s.d),p=t.n,o=s.x,n=s.r===B.ci?new Float32Array(A.a3(A.f([1/o.c,0],p))):new Float32Array(A.a3(A.f([0,1/o.d],p)))
...
aa(a){var s=this,r="dofComposite",q=s.a.ag(new A.aQ(r,s.b,s.c,B.q,B.eR,B.ej)),p=A.ca(s.d)
...
aa(a){var s=this,r=s.a.ag(new A.aQ("grade",s.b,s.c,B.q,B.eP,B.eF)),q=A.ca(s.d),p=s.r
...
aa(a){var s=this,r=s.a.ag(new A.aQ("present",s.b,s.c,B.q,B.eY,B.m)),q=A.ca(s.d),p=s.f
...
aa(a){var s=this,r="ps1Quantize",q=s.a.ag(new A.aQ(r,s.b,s.c,B.q,B.eU,B.ed)),p=A.ca(s.d),o=s.e
...
aa(a){var s=this,r="ssaoOcclusion",q=s.a.ag(new A.aQ(r,s.b,s.c,B.q,B.eT,B.ea)),p=A.ca(s.d)
...
aa(a){var s=this,r="ssaoBlur",q=s.a.ag(new A.aQ(r,s.b,s.c,B.q,B.eM,B.eI)),p=A.ca(s.d)
...
aa(a){var s=this,r=s.a.ag(new A.aQ("vhs",s.b,s.c,B.q,B.eN,B.ee)),q=A.ca(s.d),p=s.r
...
q.sb8(null)
B.a.k(p.c,s);++p.e},
bb(){return new A.cb(this.l6(),this.$ti.i("cb<+(1,2)>"))},
l6(){var s=this
...
q=A.V([a0,B.H],s,t.fB)
p=A.ar([a0],s)
for(s=this.b,o=this.a,n=o.e,m=t.R,l=p.$ti.c;p.a!==0;){k=A.L(p,l)
B.a.Y(k,new A.ko(r))
j=B.a.gao(k)
p.ah(0,j)
if(j===a1){s=q.h(0,j)
...
s.shaderSource(r,b)
s.compileShader(r)
if(!J.a9(A.cD(s.getShaderParameter(r,A.a(v.G.WebGL2RenderingContext.COMPILE_STATUS))),!0))throw A.d(A.e7("shader compile failed: "+A.q(A.tl(s,"getShaderInfoLog",r,t.x))+"\n"+b))
return r},
...
p.attachShader(o,q)
p.linkProgram(o)
if(!J.a9(A.cD(p.getProgramParameter(o,A.a(s.WebGL2RenderingContext.LINK_STATUS))),!0))throw A.d(A.e7("program link failed: "+A.q(A.tl(p,"getProgramInfoLog",o,t.x))))
return o},
...
A.ex.prototype={}
A.lv.prototype={
iS(){var s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3=new A.lM(),a4=this.b,a5=A.ax(a4,!0,t.V)
B.a.H(a4)
s=A.f([],t.kl)
...
f=c.x
a5.f5(o,i,h,g,0,f)
a5.ea(a6,l,c.an(l),c.a6(l),c.a6(l)+g,0,f)}}for(s=new A.U(a6,a6.$ti.i("U<1,2>")).gu(0);s.m();){b=s.d
a=b.b
r=J.bZ(a)
r.Y(a,new A.lN())
...
r=A.ar([a],t.N)
for(q=this.e,p=t.R;s.length!==0;){o=B.a.lx(s,0)
n=o.a
m=o.b
...
if(!h.d||h.e)continue
g=h.c
B.a.k(s,new A.c4(new A.b(l+g.a,k+g.b,m+g.c),16760178,4.8,1.6*this.jO(j),0.06))}}B.a.Y(s,new A.lE(b))
...
.lU,A.c4,A.hZ,A.aU,A.bc,A.aY,A.bb,A.cF,A.cP,A.aG,A.lG,A.c0,A.lw,A.f3,A.lF,A.eb,A.lK,A.fj,A.fb,A.nI,A.ic,A.bm,A.lX,A.kD,A.e0,A.kE,A.m8,A.m7,A.mw,A.mv,A.mx,A.mX,A.iC,A.mV,A.el,A.kP,A.nM,A.dD,A.hB,A.lQ,A.lS,A.n1,A.c6,A.n2,A.hS,A.ni,A.dB,A.dA,A.fB,A.nn,A.ke,A.kG,A.kT,A.fi,A.mF,A.bQ,A.kb,A.j1,A.nH,A.cx,A.bv,A.bG,A.be,A.j3,A.hk,A.j0,A.fU,A.er,A.jt])
...
r(J.lW,J.r)
q(J.dj,[J.f5,J.i8])
q(A.n,[A.cV,A.F,A.cn,A.R,A.bY,A.dJ,A.cb])
q(A.cV,[A.d6,A.h9])
r(A.fJ,A.d6)
r(A.fH,A.h9)
...
q(A.bR,[A.ei,A.i0])
r(A.jc,A.h4)
q(A.jg,[A.dt,A.dh,A.hl,A.cv,A.e5,A.hs,A.hz,A.hI,A.dv,A.e9,A.bT,A.fq,A.cj,A.ej,A.ea,A.fG,A.fI,A.hU,A.f0,A.hW,A.hX,A.df,A.f1,A.dx,A.cR,A.e3,A.ew,A.hr,A.d5,A.hD,A.hF,A.aH,A.hp,A.bD,A.de,A.db,A.dc,A.eZ,A.cH,A.cI,A.fo,A.du,A.bd,A.b_,A.i2,A.dE,A.bF,A.b8,A.bt,A.bu,A.cT,A.c9])
q(A.cq,[A.b9,A.bs,A.c3,A.ir,A.ck])
r(A.mS,A.nN)
r(A.mR,A.mS)
...
s(A.ey,A.h2)
s(A.h3,A.jI)})()
var v={G:typeof self!="undefined"?self:globalThis,typeUniverse:{eC:new Map(),tR:{},eT:{},tPV:{},sEA:[]},mangledGlobalNames:{j:"int",v:"double",aN:"num",m:"String",t:"bool",ak:"Null",E:"List",B:"Object",W:"Map",Z:"JSObject"},mangledNames:{},types:["~(Z)","~()","ci()","ak(Z)","t(m)","t(v)","@(@)","t(al)","~(~())","ak()","~(@)","t(Q)","t(B?)","t(aU)","t(@)","j(bm,bm)","t(be)","t()","j()","@(m)","ak(@)","~(B?,B?)","@()","t(j)","m?(m)","t(bm)","m(B?)","0&()","~(t)","j(@,@)","em?()","j(a0,a0)","~(B,c7)","ak(B,c7)","ck(j,j,m?)","fp(b9)","ci(m{fallback:m?})","~(@,@)","ak(~())","e2()","v()","aZ(br)","j(as<ba>,as<ba>)","br(as<ba>)","j(as<b7>,as<b7>)","br(as<b7>)","dr(v,v,v,v)","z(z)","@(@,m)","~(dy)","dy()","W<m,m>(W<m,m>,m)","bn<ak>(P<m,m>)","0&(m,j?)","t(E<m>)","j(m,m)","j(bc,bc)","t(Z)","Z()","B?(B?)","t(bD)","t(aG)","ak(@,c7)","dY(B?)","dX(B?)","dZ(B?)","~(j,@)","cL(c3)","e_(B?)","c3(j,j,m?)","t(cP)","t(cX)","t(cW)","b(b)","~(j)","E<+(v,v,v,v)>()","t(bc)","j(j,aG)","t(c1)","b9(j,j,m?)","j(c4,c4)
>"),bM:s("r<+(m,E<bc>)>"),fR:s("r<+(j,m)>"),a3:s("r<+(v,v,v,v)>"),o5:s("r<aa>"),u:s("r<a0>"),oZ:s("r<fn>"),C:s("r<Q>"),c8:s("r<aZ>"),bH:s("r<br>"),kl:s("r<aG>"),e_:s("r<c6>"),b2:s("r<el>"),ao:s("r<as<b7>>"),mX:s("r<as<ba>>"),jn:s("r<cP>"),s:s("r<m>"),aA:s("r<iN>"),k:s("r<z>"),h:s("r<b>"),cF:s("r<fB>"),bl:s("r<cx>"),ah:s("r<bG>"),E:s("r<aU>"),jX:s("r<cX>"),a9:s("r<cW>"),jU:s("r<jt>"),dz:s("r<cY<cL>>"),jk:s("r<cY<bU>>"),n_:s("r<cY<aZ>>"),mQ:s("r<cY<cy>>"),eP:s("r<ex>"),df:s("r<t>"),n:s("r<v>"),dG:s("r<@>"),t:s("r<j>"),kC:s("r<Z?>"),dM:s("r<B?>"),g2:s("r<aN>"),w:s("f6"),m:s("Z"),d4:s("Z()"),dY:s("cm"),dX:s("bp<@>"),bY:s("E<bm>"),b:s("E<bo>"),l_:s("E<W<m,m>>"),O:s("E<al>"),b3:s("E<c4>"),fB:s("E<bc>"),jz:s("E<+(j,m)>"),ge:s("E<+(v,v,v,v)>"),io:s("E<c6>"),a:s("E<m>"),iD:s("E<fB>"),ee:s("E<cx>"),eU:s("E<bG>"),cu:s("E<fK>"),j:s("E<@>"),J:s("E<j>"),ia:s("E<B?>"),mK:s("fb"),q:s("P<m,m>"),d7:s("P<@,@>"),iI:s("P<j,@>"),f7:s("W<m,ci>"),iE:s("W<m,al>"),G:s("W<m,m>"),oQ:s("W<m,t>"),P:s("W<m,@>"),f:s("W<@,@>"),d8:s("W<j,dA>"),c_:s("W<j,dB>"),gz:s("W<m,E<+(v,v,v,v)>>"),kz:s("W<bu,E<bG>>"),iu:s("W<j,W<m,m>>"),mz:s("S<z,z>"),dD:s("S<m,m?>"),fP:s("c3"),l0:s("b9"),eb:s("eg"),mR:s("dq"),c:s("ak"),K:s("B"),nL:s("ba"),A:s("al"),f0:s("c4"),R:s("bc"),ku:s("fj"),lZ:s("zs"),aK:s("+()"),o7:s("+(b9,bU)"),p3:s("+(bs,cy)"),cW:s("+(v,v,v,v)"),ks:s("a0"),mo:s("c5<ck,aZ>"),kk:s("c5<c3,cL>"),ll:s("c5<b9,bU>"),ox:s("c5<bs,cy>"),n4:s("Q"),p9:s("aZ"),os:s("br"),V:s("aG"),k8:s("c6"),T:s("cO<m>"),nO:s("cO<j>"),m9:s("b_"),gC:s("bd"),ad:s("el"),d:s("as<b7>"),p:s("as<ba>"),l:s("c7"),fO:s("cP"),dB:s("aH"),N:s("m"),lu:s("bs"),aJ:s("a1"),do:s("ct"),cx:s("dz"),ph:s("cS<m,m>"),mL:s("iT"),jJ:s("iU"),b9:s("z"),bf:s("b"),pc:s("z(z)"),g:s("be"),nq:s("bt"),kM:s("bu"),bR:s("dA"),ey:s("dB"),mv:s("cx"),kX:s("bG"),cq:s("bf"),bn:s("R<b8>"),ns:s("R<bD>"),hr:s("R<b_>"),am:s("R<bd>"),nn:s("R<m>"),cB:s("R<bt>"),na:s("R<bu>"),lS:s("bY<m>"),Z:s("aU"),fH:s("fK"),e:s("aj<@>"),mp:s("fN<B?,B?>"),j8:s("jq"),fg:s("cX"),at:s("cW"),ln:s("jr"),fw:s("js"),bp:s("jB"),hX:s("jE"),fJ:s("cb<br>"),jg:s("h6"),fL:s("h7"),y:s("t"),al:s("t()"),hg:s("t(b8)"),gl:s("t(bD)"),iW:s("t(B)"),aZ:s("t(b_)"),gw:s("t(bd)"),dA:s("t(m)"),bQ:s("t(bt)"),nw:s("t(bu)"),i:s("v"),z:s("@"),mY:s("@()"),mq:s("@(B)"),ng:s("@(B,c7)"),S:s("j"),gK:s("bn<ak>?"),mU:s("Z?"),lH:s("E<@>?"),X:s("B?"),x:s("m?"),ej:s("m?(m)"),nh:s("fx?"),F:s("dF<@,@>?"),Y:s("jo?"),fU:s("t?"),hK:s("t(ek)?"),dC:s("v?"),aV:s("j?"),jh:s("aN?"),jE:s("~()?"),as:s("~(bd,b_)?"),ov:s("~(m)?"),hm:s("~(m,v)?"),cz:s("~(t)?"),bZ:s("~(j)?"),o:s("aN"),H:s("~"),M:s("~()"),lc:s("~(m,@)")}})();(function constants(){var s=hunkHelpers.makeConstList
B.e2=J.i3.prototype
B.a=J.r.prototype
B.c=J.f5.prototype
B.d=J.dj.prototype
...
B.ao=s([B.hf,B.hg,B.hh,B.hi,B.hj,B.hk],A.aq("r<cw>"))
B.T=new A.nA()
B.aU=new A.jl()
B.r=new A.jx()
B.U=new A.jG()
...
B.eh=s([B.fy,B.fw,B.fv,B.fr,B.fz],A.aq("r<+(m,m,v)>"))
...
B.fQ=new A.bd(0,"long")
B.c7=new A.bd(1,"short")
B.bk=s([B.fQ,B.c7],A.aq("r<bd>"))
...
B.fN=new A.b_(0,"bed")
B.fO=new A.b_(1,"chair")
B.fP=new A.b_(2,"floor")
B.bp=s([B.fN,B.fO,B.fP],A.aq("r<b_>"))
...
B.eC=s([B.aA,B.aB,B.aC,B.aD,B.aE,B.aF,B.aG,B.aH,B.ca,B.fR,B.c8,B.c9],A.aq("r<aH>"))
...
B.fa={uAlbedo:0}
B.bs=new A.a4(B.fa,[0],t.I)
B.f_={bluenoise:0,"lut-gothic":1,grime:2,glass:3,soft:4}
B.bt=new A.a4(B.f_,[2,3,4,5,6],t.I)
B.fj={uAlbedo:0,uShadowMap:1,uSsao:2}
B.eL=new A.a4(B.fj,[0,1,2],t.I)
B.fh={uSsaoRaw:0,uSceneDepth:1}
B.eM=new A.a4(B.fh,[0,1],t.I)
B.fe={uScene:0,uHistory:1}
B.eN=new A.a4(B.fe,[0,1],t.I)
B.f0={RENDERER_SHA:0,GAME_SHA:1,DART_SDK_VERSION:2,LOCKFILE_SHA256:3}
B.eO=new A.a4(B.f0,["08daacb75415782a2c3cc58f0115a104c77de0da","406b7136876f38b3d291a2b93b9a639a7e814df7","3.12.2","45ec8ddeeb3836a9419f1d3ed4d340f60e610615db671faa136c79cf675fdb29"],t.D)
B.f7={aPosition:0,aUvMat:1}
B.bu=new A.a4(B.f7,[0,4],t.I)
B.ff={uScene:0,uLut:1}
B.eP=new A.a4(B.ff,[0,1],t.I)
B.fg={uSource:0}
B.bv=new A.a4(B.fg,[0],t.I)
...
B.eR=new A.a4(B.f6,[0,1,2],t.I)
B.fb={uBloom:0}
B.eS=new A.a4(B.fb,[0],t.I)
B.fc={uSceneDepth:0}
B.eT=new A.a4(B.fc,[0],t.I)
B.fd={uScene:0}
B.eU=new A.a4(B.fd,[0],t.I)
B.N={}
...
B.eW=new A.a4(B.f8,[0,1,2,3],t.I)
B.f3={aPosition:0,aNormal:1,aColor:2,aAlpha:3,aUvMat:4}
B.eX=new A.a4(B.f3,[0,1,2,3,4],t.I)
B.fi={uTex:0}
B.eY=new A.a4(B.fi,[0],t.I)
...
B.C=new A.c_(B.N,0,t.Q)
B.a_=new A.ds(B.aq,B.C)
B.f9={shadows:0}
B.fL=new A.c_(B.f9,1,t.Q)
B.fn=new A.ds(B.ar,B.fL)
B.f4={shadows:0,ssao:1,bloom:2,dof:3,grade:4}
B.fI=new A.c_(B.f4,5,t.Q)
B.fo=new A.ds(B.as,B.fI)
B.fm=new A.dt(4,"shipping")
B.f5={shadows:0,ssao:1,bloom:2,dof:3,grade:4,ps1:5,vhs:6}
B.fJ=new A.c_(B.f5,7,t.Q)
B.hU=new A.ds(B.fm,B.fJ)
...
B.hl=new A.cT(0,"visitorAnswered")
B.cd=new A.cT(1,"visitorIgnored")
B.hm=new A.cT(2,"entryVerified")
B.hn=new A.cT(3,"entryContradicted")
B.ho=new A.cT(4,"exposureAccepted")
B.hq=new A.c9(1,"malformedDay")
B.hr=new A.c9(2,"malformedTier")
B.ce=new A.c9(3,"missingTierLines")
B.aN=new A.c9(6,"invalidPhase")
B.hx=new A.bv(B.aN,"The active visit cannot be chosen.")
B.hA=new A.bf(B.hx)
B.hu=new A.bv(B.aN,"The active visit has no line to advance.")
B.hB=new A.bf(B.hu)
B.ht=new A.c9(5,"noActiveVisit")
B.hv=new A.bv(B.ht,"There is no active visit.")
B.cf=new A.bf(B.hv)
B.hw=new A.bv(B.aN,"A visit is already active.")
B.hC=new A.bf(B.hw)
B.hs=new A.c9(4,"noArrival")
B.hz=new A.bv(B.hs,"The authored arrival is missing.")
B.hD=new A.bf(B.hz)
B.hp=new A.c9(0,"missingCorpus")
B.hy=new A.bv(B.hp,"The authored visitor corpus is empty.")
B.hE=new A.bf(B.hy)
B.cg=new A.dE(1,"exact")
B.aO=new A.dE(2,"partial")
B.a9=new A.dE(3,"contradiction")
B.hF=new A.dE(0,"skipped")
B.hG=new A.dD(B.hF,B.C)
B.hH=new A.dD(B.aO,B.C)
B.hI=new A.fD(B.H,!1)
B.hJ=new A.fD(B.H,!0)
