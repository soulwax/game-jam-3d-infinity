...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      YC: (x0,x1,x2) => x0.translate(x1,x2),
      ...
      eB: x0 => x0.disconnect(),
      eC: (x0,x1,x2) => x0.lineTo(x1,x2),
      eD: b => !!b,
      eE: (o, offsetInBytes, lengthInBytes) => {
      ...
      fE: Function.prototype.call.bind(String.prototype.toLowerCase),
