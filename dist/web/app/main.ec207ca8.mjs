...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _402: x0 => x0.getSupportedExtensions(),
      _403: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _404: x0 => x0.createQuery(),
      _405: (x0,x1,x2) => x0.beginQuery(x1,x2),
      _406: (x0,x1) => x0.endQuery(x1),
      _408: (x0,x1) => x0.deleteQuery(x1),
      _409: (x0,x1) => x0.depthFunc(x1),
      _410: (x0,x1) => x0.frontFace(x1),
      _411: (x0,x1) => x0.blendEquation(x1),
      _412: (x0,x1,x2,x3,x4,x5) => x0.uniform4f(x1,x2,x3,x4,x5),
      _413: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texSubImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _414: (x0,x1) => x0.deleteShader(x1),
      _415: (x0,x1) => x0.deleteProgram(x1),
      _416: x0 => x0.save(),
      _417: (x0,x1,x2) => x0.scale(x1,x2),
      _418: (x0,x1,x2,x3,x4) => x0.clearRect(x1,x2,x3,x4),
      _419: x0 => x0.restore(),
      _420: (x0,x1,x2) => x0.translate(x1,x2),
      _421: x0 => x0.fill(),
      _422: x0 => x0.stroke(),
      _423: (x0,x1) => x0.rotate(x1),
      _424: x0 => x0.beginPath(),
      _425: (x0,x1,x2) => x0.moveTo(x1,x2),
      _426: (x0,x1,x2) => x0.lineTo(x1,x2),
      _427: (x0,x1,x2,x3,x4,x5) => x0.arc(x1,x2,x3,x4,x5),
      _428: (x0,x1,x2,x3) => x0.fillText(x1,x2,x3),
      _429: (x0,x1,x2,x3,x4) => x0.strokeRect(x1,x2,x3,x4),
      _430: (x0,x1) => x0.measureText(x1),
      _431: (x0,x1,x2,x3,x4) => x0.fillRect(x1,x2,x3,x4),
      _432: x0 => x0.closePath(),
      ...
      _448: (x0,x1,x2) => x0.setTimeout(x1,x2),
      _449: (module,f) => finalizeWrapper(f, function() { return module.exports._449(f,arguments.length) }),
      _450: (x0,x1) => x0.removeItem(x1),
      ...
      _458: x0 => x0.getGamepads(),
      _459: x0 => x0.createGain(),
      _460: x0 => x0.createConvolver(),
      _461: (x0,x1) => x0.connect(x1),
      _462: x0 => x0.createBiquadFilter(),
      _463: (x0,x1) => x0.disconnect(x1),
      _464: (x0,x1) => x0.createChannelSplitter(x1),
      _465: (x0,x1) => x0.createChannelMerger(x1),
      _466: x0 => x0.disconnect(),
      _467: (x0,x1,x2) => x0.connect(x1,x2),
      _468: (x0,x1,x2,x3) => x0.connect(x1,x2,x3),
      _469: x0 => x0.resume(),
      _470: () => new AudioContext(),
      _471: x0 => x0.arrayBuffer(),
      _472: (x0,x1) => x0.decodeAudioData(x1),
      _473: (x0,x1,x2,x3) => x0.createBuffer(x1,x2,x3),
      _474: (x0,x1,x2) => x0.copyToChannel(x1,x2),
      _475: x0 => x0.createBufferSource(),
      _476: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._476(f,arguments.length,x0) }),
      _477: x0 => x0.start(),
      _478: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._478(f,arguments.length,x0) }),
      _479: x0 => x0.createPanner(),
      _480: (x0,x1,x2,x3) => x0.setPosition(x1,x2,x3),
      _481: (x0,x1,x2,x3,x4,x5,x6) => x0.setOrientation(x1,x2,x3,x4,x5,x6),
      _482: (x0,x1) => x0.cancelScheduledValues(x1),
      _483: (x0,x1,x2) => x0.setValueAtTime(x1,x2),
      _484: (x0,x1,x2) => x0.linearRampToValueAtTime(x1,x2),
      _485: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._485(f,arguments.length,x0) }),
      _487: o => o instanceof Array,
      _493: (a, s) => a.join(s),
      _496: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _497: a => a.length,
      _499: (a, i) => a[i],
      _500: (a, i, v) => a[i] = v,
      _505: o => {
      ...
      _506: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _507: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _508: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _509: o => o instanceof Uint8ClampedArray,
      _510: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _511: o => o instanceof Uint16Array,
      _512: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _513: o => o instanceof Int16Array,
      _514: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _515: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _516: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _517: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _518: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _521: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _522: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _523: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _524: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _526: (t, s) => t.set(s),
      _528: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _530: o => o.buffer,
      _531: o => o.byteOffset,
      _532: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _533: (b, o) => new DataView(b, o),
      _534: (b, o, l) => new DataView(b, o, l),
      _535: Function.prototype.call.bind(DataView.prototype.getUint8),
      _536: Function.prototype.call.bind(DataView.prototype.setUint8),
      _537: Function.prototype.call.bind(DataView.prototype.getInt8),
      _538: Function.prototype.call.bind(DataView.prototype.setInt8),
      _539: Function.prototype.call.bind(DataView.prototype.getUint16),
      _540: Function.prototype.call.bind(DataView.prototype.setUint16),
      _541: Function.prototype.call.bind(DataView.prototype.getInt16),
      _542: Function.prototype.call.bind(DataView.prototype.setInt16),
      _543: Function.prototype.call.bind(DataView.prototype.getUint32),
      _544: Function.prototype.call.bind(DataView.prototype.setUint32),
      _545: Function.prototype.call.bind(DataView.prototype.getInt32),
      _546: Function.prototype.call.bind(DataView.prototype.setInt32),
      _551: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _552: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _553: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _554: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _555: Function.prototype.call.bind(Number.prototype.toString),
      _556: Function.prototype.call.bind(BigInt.prototype.toString),
      _557: Function.prototype.call.bind(Number.prototype.toString),
      _558: (d, digits) => d.toFixed(digits),
      _674: x0 => x0.style,
      _1117: (x0,x1) => { x0.src = x1 },
      _1130: x0 => x0.width,
      _1132: x0 => x0.height,
      _1133: x0 => x0.naturalWidth,
      _1134: x0 => x0.naturalHeight,
      _1620: (x0,x1) => { x0.checked = x1 },
      _1621: x0 => x0.checked,
      _1624: (x0,x1) => { x0.disabled = x1 },
      _1644: (x0,x1) => { x0.max = x1 },
      _1648: (x0,x1) => { x0.min = x1 },
      _1668: (x0,x1) => { x0.step = x1 },
      _1670: (x0,x1) => { x0.type = x1 },
      _1674: (x0,x1) => { x0.value = x1 },
      _1675: x0 => x0.value,
      _1703: (x0,x1) => { x0.disabled = x1 },
      _1718: (x0,x1) => { x0.type = x1 },
      _1758: (x0,x1) => { x0.value = x1 },
      _1759: x0 => x0.value,
      _1778: (x0,x1) => { x0.value = x1 },
      _1956: (x0,x1) => { x0.width = x1 },
      _1957: x0 => x0.width,
