...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _331: (x0,x1) => x0.requestAnimationFrame(x1),
      ...
      _334: (x0,x1) => x0.getAttribute(x1),
      _335: x0 => x0.json(),
      _336: (x0,x1) => x0.contains(x1),
      _337: (x0,x1) => x0.querySelectorAll(x1),
      _338: (x0,x1) => x0.item(x1),
      _339: (x0,x1) => x0.removeAttribute(x1),
      _340: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._340(f,arguments.length,x0) }),
      _341: (x0,x1,x2,x3,x4) => x0.clearColor(x1,x2,x3,x4),
      _342: (x0,x1) => x0.clear(x1),
      _343: (x0,x1,x2,x3,x4) => x0.colorMask(x1,x2,x3,x4),
      _344: (x0,x1) => x0.cullFace(x1),
      _345: (x0,x1) => x0.getExtension(x1),
      _346: (x0,x1) => x0.getParameter(x1),
      _347: x0 => x0.createTexture(),
      _348: (x0,x1,x2) => x0.pixelStorei(x1,x2),
      _349: (x0,x1,x2,x3,x4,x5,x6) => x0.texImage2D(x1,x2,x3,x4,x5,x6),
      _350: (x0,x1,x2,x3) => x0.texParameteri(x1,x2,x3),
      _351: (x0,x1) => x0.generateMipmap(x1),
      _352: (x0,x1,x2,x3) => x0.texParameterf(x1,x2,x3),
      _353: (x0,x1,x2,x3,x4,x5,x6) => x0.texStorage3D(x1,x2,x3,x4,x5,x6),
      _354: x0 => x0.getError(),
      _355: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11) => x0.texSubImage3D(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11),
      _356: (x0,x1) => x0.deleteTexture(x1),
      _357: (x0,x1) => x0.createShader(x1),
      _358: (x0,x1,x2) => x0.shaderSource(x1,x2),
      _359: (x0,x1) => x0.compileShader(x1),
      _360: (x0,x1,x2) => x0.getShaderParameter(x1,x2),
      _361: (x0,x1) => x0.getShaderInfoLog(x1),
      _362: x0 => x0.createProgram(),
      _363: (x0,x1,x2) => x0.attachShader(x1,x2),
      _364: (x0,x1) => x0.linkProgram(x1),
      _365: (x0,x1,x2) => x0.getProgramParameter(x1,x2),
      _366: (x0,x1) => x0.getProgramInfoLog(x1),
      _367: (x0,x1,x2,x3) => x0.bufferSubData(x1,x2,x3),
      _368: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _369: x0 => x0.createRenderbuffer(),
      _370: (x0,x1,x2) => x0.bindRenderbuffer(x1,x2),
      _371: (x0,x1,x2,x3,x4,x5) => x0.renderbufferStorageMultisample(x1,x2,x3,x4,x5),
      _372: (x0,x1,x2,x3,x4) => x0.renderbufferStorage(x1,x2,x3,x4),
      _373: (x0,x1,x2,x3,x4) => x0.framebufferRenderbuffer(x1,x2,x3,x4),
      _374: (x0,x1,x2,x3,x4,x5) => x0.framebufferTexture2D(x1,x2,x3,x4,x5),
      _375: (x0,x1,x2,x3,x4,x5) => x0.texStorage2D(x1,x2,x3,x4,x5),
      _376: x0 => x0.createFramebuffer(),
      _377: (x0,x1,x2) => x0.bindFramebuffer(x1,x2),
      _378: (x0,x1) => x0.drawBuffers(x1),
      _379: (x0,x1) => x0.checkFramebufferStatus(x1),
      _380: (x0,x1) => x0.readBuffer(x1),
      _381: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => x0.blitFramebuffer(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10),
      _382: (x0,x1) => x0.deleteFramebuffer(x1),
      _383: (x0,x1) => x0.deleteRenderbuffer(x1),
      _384: (x0,x1,x2,x3,x4) => x0.viewport(x1,x2,x3,x4),
      ...
      _400: x0 => x0.getSupportedExtensions(),
      _401: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _402: x0 => x0.createQuery(),
      _403: (x0,x1,x2) => x0.beginQuery(x1,x2),
      _404: (x0,x1) => x0.endQuery(x1),
      _406: (x0,x1) => x0.deleteQuery(x1),
      _407: (x0,x1) => x0.depthFunc(x1),
      _408: (x0,x1) => x0.frontFace(x1),
      _409: (x0,x1) => x0.blendEquation(x1),
      _410: (x0,x1,x2,x3,x4,x5) => x0.uniform4f(x1,x2,x3,x4,x5),
      _411: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => x0.texSubImage2D(x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _412: (x0,x1) => x0.deleteShader(x1),
      _413: (x0,x1) => x0.deleteProgram(x1),
      ...
      _431: (module,f) => finalizeWrapper(f, function() { return module.exports._431(f,arguments.length) }),
      _432: (x0,x1,x2) => x0.setTimeout(x1,x2),
      _433: (module,f) => finalizeWrapper(f, function() { return module.exports._433(f,arguments.length) }),
      _434: (x0,x1) => x0.removeItem(x1),
      ...
      _442: x0 => x0.getGamepads(),
      _443: x0 => x0.createGain(),
      _444: x0 => x0.createConvolver(),
      _445: (x0,x1) => x0.connect(x1),
      _446: x0 => x0.createBiquadFilter(),
      _447: (x0,x1) => x0.disconnect(x1),
      _448: (x0,x1) => x0.createChannelSplitter(x1),
      _449: (x0,x1) => x0.createChannelMerger(x1),
      _450: x0 => x0.disconnect(),
      _451: (x0,x1,x2) => x0.connect(x1,x2),
      _452: (x0,x1,x2,x3) => x0.connect(x1,x2,x3),
      _453: x0 => x0.resume(),
      _454: () => new AudioContext(),
      _455: x0 => x0.arrayBuffer(),
      _456: (x0,x1) => x0.decodeAudioData(x1),
      _457: (x0,x1,x2,x3) => x0.createBuffer(x1,x2,x3),
      _458: (x0,x1,x2) => x0.copyToChannel(x1,x2),
      _459: x0 => x0.createBufferSource(),
      _460: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._460(f,arguments.length,x0) }),
      _461: x0 => x0.start(),
      _462: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._462(f,arguments.length,x0) }),
      _463: x0 => x0.createPanner(),
      _464: (x0,x1,x2,x3) => x0.setPosition(x1,x2,x3),
      _465: (x0,x1,x2,x3,x4,x5,x6) => x0.setOrientation(x1,x2,x3,x4,x5,x6),
      _466: (x0,x1) => x0.cancelScheduledValues(x1),
      _467: (x0,x1,x2) => x0.setValueAtTime(x1,x2),
      _468: (x0,x1,x2) => x0.linearRampToValueAtTime(x1,x2),
      _469: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._469(f,arguments.length,x0) }),
      _471: o => o instanceof Array,
      _477: (a, s) => a.join(s),
      _480: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _481: a => a.length,
      _483: (a, i) => a[i],
      _484: (a, i, v) => a[i] = v,
      _489: o => {
      ...
      _490: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _491: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int8Array) return 1;
        return 2;
      },
      _492: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _493: o => o instanceof Uint8ClampedArray,
      _494: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _495: o => o instanceof Uint16Array,
      _496: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _497: o => o instanceof Int16Array,
      _498: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _499: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Uint32Array) return 1;
        return 2;
      },
      _500: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _501: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Int32Array) return 1;
        return 2;
      },
      _502: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _505: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float32Array) return 1;
        return 2;
      },
      _506: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _507: o => {
        if (o === null || o === undefined) return 0;
        if (o instanceof Float64Array) return 1;
        return 2;
      },
      _508: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _510: (t, s) => t.set(s),
      _512: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _514: o => o.buffer,
      _515: o => o.byteOffset,
      _516: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _517: (b, o) => new DataView(b, o),
      _518: (b, o, l) => new DataView(b, o, l),
      _519: Function.prototype.call.bind(DataView.prototype.getUint8),
      _520: Function.prototype.call.bind(DataView.prototype.setUint8),
      _521: Function.prototype.call.bind(DataView.prototype.getInt8),
      _522: Function.prototype.call.bind(DataView.prototype.setInt8),
      _523: Function.prototype.call.bind(DataView.prototype.getUint16),
      _524: Function.prototype.call.bind(DataView.prototype.setUint16),
      _525: Function.prototype.call.bind(DataView.prototype.getInt16),
      _526: Function.prototype.call.bind(DataView.prototype.setInt16),
      _527: Function.prototype.call.bind(DataView.prototype.getUint32),
      _528: Function.prototype.call.bind(DataView.prototype.setUint32),
      _529: Function.prototype.call.bind(DataView.prototype.getInt32),
      _530: Function.prototype.call.bind(DataView.prototype.setInt32),
      _535: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _536: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _537: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _538: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _539: Function.prototype.call.bind(Number.prototype.toString),
      _540: Function.prototype.call.bind(BigInt.prototype.toString),
      _541: Function.prototype.call.bind(Number.prototype.toString),
      _542: (d, digits) => d.toFixed(digits),
      _658: x0 => x0.style,
      _1101: (x0,x1) => { x0.src = x1 },
      _1114: x0 => x0.width,
      _1116: x0 => x0.height,
      _1117: x0 => x0.naturalWidth,
      _1118: x0 => x0.naturalHeight,
      _1604: (x0,x1) => { x0.checked = x1 },
      _1605: x0 => x0.checked,
      _1608: (x0,x1) => { x0.disabled = x1 },
      _1628: (x0,x1) => { x0.max = x1 },
      _1632: (x0,x1) => { x0.min = x1 },
      _1652: (x0,x1) => { x0.step = x1 },
      _1654: (x0,x1) => { x0.type = x1 },
      _1658: (x0,x1) => { x0.value = x1 },
      _1659: x0 => x0.value,
      _1687: (x0,x1) => { x0.disabled = x1 },
      _1702: (x0,x1) => { x0.type = x1 },
      _1742: (x0,x1) => { x0.value = x1 },
      _1743: x0 => x0.value,
      _1762: (x0,x1) => { x0.value = x1 },
      _1940: (x0,x1) => { x0.width = x1 },
      _1941: x0 => x0.width,
      _1942: (x0,x1) => { x0.height = x1 },
      _1943: x0 => x0.height,
      _2072: x0 => x0.data,
      ...
      _4189: () => globalThis.WebGL2RenderingContext.NO_ERROR,
      ...
      _4321: () => globalThis.WebGL2RenderingContext.TEXTURE1,
      _4327: () => globalThis.WebGL2RenderingContext.TEXTURE7,
      _4328: () => globalThis.WebGL2RenderingContext.TEXTURE8,
      _4329: () => globalThis.WebGL2RenderingContext.TEXTURE9,
      _4330: () => globalThis.WebGL2RenderingContext.TEXTURE10,
      _4331: () => globalThis.WebGL2RenderingContext.TEXTURE11,
      ...
      _4423: () => globalThis.WebGL2RenderingContext.UNPACK_FLIP_Y_WEBGL,
      ...
      _4837: x0 => x0.canvas,
      _4838: x0 => x0.drawingBufferWidth,
      _4839: x0 => x0.drawingBufferHeight,
      _5445: x0 => x0.destination,
      _5446: x0 => x0.sampleRate,
      _5447: x0 => x0.currentTime,
      _5448: x0 => x0.listener,
      _5449: x0 => x0.state,
      _5565: (x0,x1) => { x0.value = x1 },
      _5566: x0 => x0.value,
      _5574: (x0,x1) => { x0.onended = x1 },
      _5601: (x0,x1) => { x0.buffer = x1 },
      _5603: x0 => x0.playbackRate,
      _5605: (x0,x1) => { x0.loop = x1 },
      _5647: (x0,x1) => { x0.type = x1 },
      _5649: x0 => x0.frequency,
      _5678: (x0,x1) => { x0.buffer = x1 },
      _5713: x0 => x0.gain,
      _5758: (x0,x1) => { x0.panningModel = x1 },
      _5760: x0 => x0.positionX,
      _5761: x0 => x0.positionY,
      _5762: x0 => x0.positionZ,
      _5766: (x0,x1) => { x0.distanceModel = x1 },
      _5768: (x0,x1) => { x0.refDistance = x1 },
      _5770: (x0,x1) => { x0.maxDistance = x1 },
      _5772: (x0,x1) => { x0.rolloffFactor = x1 },
      _5774: (x0,x1) => { x0.coneInnerAngle = x1 },
      _6942: x0 => x0.type,
      _6953: x0 => x0.defaultPrevented,
      _6993: x0 => x0.length,
      _7058: x0 => x0.ownerDocument,
      _7062: x0 => x0.firstChild,
      _7068: (x0,x1) => { x0.textContent = x1 },
      _7073: () => globalThis.document,
      _7136: x0 => x0.documentElement,
      _7150: x0 => x0.body,
      _7163: x0 => x0.visibilityState,
      _7186: x0 => x0.activeElement,
      _7493: (x0,x1) => { x0.id = x1 },
      _7495: (x0,x1) => { x0.className = x1 },
      _7496: x0 => x0.className,
      _7497: x0 => x0.classList,
      _7727: x0 => x0.button,
      _7779: x0 => x0.deltaY,
      _7810: x0 => x0.code,
      _7813: x0 => x0.shiftKey,
      _7816: x0 => x0.repeat,
      _8581: x0 => x0.status,
      _8582: x0 => x0.ok,
      _8834: x0 => x0.matches,
      _9860: x0 => x0.id,
      _9862: x0 => x0.connected,
      _9864: x0 => x0.mapping,
      _9865: x0 => x0.axes,
      _9866: x0 => x0.buttons,
      _9868: x0 => x0.pressed,
      _9870: x0 => x0.value,
      _10526: (x0,x1) => { x0.display = x1 },
      _10527: x0 => x0.display,
      _12797: () => globalThis.console,
