...
geometry. The current checked export is 5,336 indexed vertices, 2,668
triangles, 101,424 bytes, with 33.3% exact-attribute index reuse; the latest
detail pass adds timber sash bars, recessed front-door leaf geometry, paired
chimney pots, and repeated downpipe brackets without changing collision truth.
